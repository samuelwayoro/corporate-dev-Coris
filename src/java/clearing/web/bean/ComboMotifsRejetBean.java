 ...
 * @author Patrick
 */
public class ComboMotifsRejetBean extends ComboBean{
 private String requete = "select * from params where type='CODE_REJET'";
        ...
        try {
            ...
            if (params != null && params.length > 0) {
                ...
                for (int i = 0; i < params.length; i++) {
                    ...
                    labels[i] = params[i].getNom().trim()+"-"+params[i].getLibelle();
