 ...
 * @author Patrick
 */
public class ComboTypeVirementBean extends ComboBean{
 private String requete = "select * from params where type='CODE_OPERATION' AND NOM LIKE 'VIR%'";
        ...
        try {
            ...
            if (params != null && params.length > 0) {
                ...
                for (int i = 0; i < params.length; i++) {
                    ...
                    labels[i] = params[i].getValeur().trim()+"-"+params[i].getLibelle();
