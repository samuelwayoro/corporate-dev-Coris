 ...
 * @author Patrick
 */
public class ComboCompteBDKBean extends ComboBean {

    private String requete = "select x0.age AGENCE, x0.ser SERVICE,x0.ncp COMPTE,SUBSTR(x0.inti,1,30) NOM,x0.ribdec CLERIB,x0.CPRO TYPECPT from bkcom x0 where x0.cfe='N' and x0.ife='N' and x0.dev='001' and cpro is not null ";
