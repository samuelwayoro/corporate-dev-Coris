...
import clearing.action.readers.flexcube.VirementNSIAXLSReader;
 ...
 * @author DavyStephane
 */
public class VirementNSIAFileUpload extends HttpServlet {
            ...
            try {
                ...
                for (FileItem item : items) {
                    if (!item.isFormField()) {
                        ...
                        VirementNSIAXLSReader readerVirement = new VirementNSIAXLSReader();
                        Repertoires repertoire = new Repertoires();
                        repertoire.setChemin(destPath);
                        repertoire.setExtension("xls");
                        repertoire.setTache("clearing.action.readers.flexcube.VirementNSIAXLSReader");
...
//                    db.insertObjectAsRowByQuery(f, "FICHIERS");
                ...
                req.getRequestDispatcher("/uploadVirements_NSIA.jsp").forward(req, resp);
            }
            session.removeAttribute("virementsAttribute");
            session.removeAttribute("fileTreated");
            session.removeAttribute("message");
