...
import clearing.action.readers.flexcube.VirementEBFXLSReader;
 ...
 * @author DavyStephane
 */
public class VirementFileUpload extends HttpServlet {
            ...
            try {
                ...
                for (FileItem item : items) {
                    if (!item.isFormField()) {
                        ...
                        VirementEBFXLSReader readerVirement = new VirementEBFXLSReader();
                        Repertoires repertoire = new Repertoires();
                        repertoire.setChemin(destPath);
                        repertoire.setExtension("xls");
                        repertoire.setTache("clearing.action.readers.flexcube.VirementEBFXLSReader");
...
//                        req.getRequestDispatcher("/resultUploadVirements.jsp").forward(req, resp);
            ...
            if (action.equals("OUI")) {
                ...
                resp.sendRedirect("uploadVirements.jsp");
                session.removeAttribute("resultat");
