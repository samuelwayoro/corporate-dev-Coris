 ...
 * @author Patrick
 */
public class ImageChequeStretchReader extends FlatFileReader  {
    ...
    public ImageChequeStretchReader() {
...
//                    }
                  ...
                  FileUtils.copyFile(aFile,new File(srvRemiseFilePath +  File.separator +  fileRoot + "f.jpg"));
                   ...
                   FileUtils.copyFile(versoFile,new File(srvRemiseFilePath +  File.separator + fileRoot + "r.jpg"));
                    ...
                    Utility.compressJpegFile(aFile,new File(pathimage + fichierimage + "f.jpg"),0.3f);
