 ...
 * @author Bouiks
 */
public class VirementESNXLSReader extends BinFileReader {
    ...
    public File treatFile(File aFile, Repertoires repertoire) throws Exception {
        ...
        System.out.println("VirementESNXLSReader treatFile");
        ...
        try {
            ...
            while (rowIterator.hasNext()) {
                ...
                String typeVirement = (row.getCell(0) != null) ? row.getCell(0).getStringCellValue() : "";
...
//                        virement.setEtat(new BigDecimal(Utility.getParam("CETAOPESTO")));
                    ...
                    if (virement.getEtat().toPlainString().equals(Utility.getParam("CETAOPEALLICOM1").trim())) {
                ...
                if (typeVirement.equalsIgnoreCase("011")) {
                    ...
                    String ribBenef = processToString(row.getCell(3));
                    ribBenef = ribBenef.replaceAll("\\p{javaWhitespace}+", "");
...
////                    }
                    ...
                    virement.setVille("01");
                    virement.setCodeUtilisateur("FICHIER");
                    virement.setNom_Tire("ECOBANK " + CMPUtility.getCodeBanqueSica3());
                    virement.setOrigine(new BigDecimal(2));
                    virement.setIdvirement(new BigDecimal(Utility.computeCompteur("IDVIREMENT", "VIREMENTS")));
        ...
        db.close();
        System.out.println("Fin VirementESNFXLSReader treatFile");
        return aFile;
