 ...
 * @author DavyStephane
 */
public class PrelevementLiteResultReader extends FlatFileReader {
    ...
    public PrelevementLiteResultReader() {
        this.listPrelevements = new ArrayList<Prelevements>();
    ...
    public File treatFile(File aFile, Repertoires repertoire) throws Exception {
        ...
        for (int i = 0; i < prelevements.length; i++) {
            ...
            String sql = "UPDATE PRELEVEMENTS SET ETAT=" + (prelevements1.getMotifrejet().equals("00") ? Utility.getParam("CETAOPEALLICOM1ACC") : Utility.getParam("CETAOPEREJRET"))
