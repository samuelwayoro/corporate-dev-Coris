...
import static org.patware.action.impl.TaskImpl.END_EXT;
 ...
 * @author DavyStephane
 */
public class PrelevementResultReader extends FlatFileReader {
    ...
    public PrelevementResultReader() {
    ...
    public File treatFile(File aFile, Repertoires repertoire) throws Exception {
        ...
        while ((line = is.readLine()) != null) {
            ...
            if (codeOperation.equalsIgnoreCase("041")) { //entete du fichier
            ...
            } else if (codeOperation.equalsIgnoreCase("042")) {  //lignes de prelevements
...
listPrelevements.add(prelevement);
        ...
        for (int i = 0; i < prelevements.length; i++) {
            ...
            String sql = "UPDATE PRELEVEMENTS SET ETAT=" + Utility.getParam("CETAOPEVALSURCAIENVSIB")
                    + ", MOTIFREJET=" + (prelevements1.getMotifrejet().equals("00") ? "'000'" : "'" + Utility.getParamNameOfType(prelevements1.getMotifrejet(), "CODE_REJET") + "'")
                    + " WHERE ETAT=" + Utility.getParam("CETAOPEVALSURCAI")
                   // + " AND DATETRAITEMENT ='" + prelevements1.getDatetraitement() + "'"
                    ...
                    + " OR REFERENCE_OPERATION_INTERNE='" + prelevements1.getReference_Operation_Interne() + "')";
            db.executeUpdate(sql);
            sql = "UPDATE PRELEVEMENTS SET ETAT=" + (prelevements1.getMotifrejet().equals("00") ?Utility.getParam("CETAOPERETENVSIB"):Utility.getParam("CETAOPEALLICOM2"))
