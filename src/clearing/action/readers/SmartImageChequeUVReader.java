 ...
 * @author Patrick
 */
public class SmartImageChequeUVReader extends FlatFileReader  {
    ...
    public SmartImageChequeUVReader() {
    ...
    private void readCodeVignette(File imageFile) {
        ...
        try {
            ...
            File tempFile = new File(pathimage + fichierimage + "suv.jpg");
...
//                Logger.getLogger(SmartImageChequeUVReader.class.getName()).log(Level.SEVERE, null, ex);
//            }
        } catch (Exception ex) {
            Logger.getLogger(SmartImageChequeUVReader.class.getName()).log(Level.SEVERE, null, ex);
        }
        codeVignetteUV="12345";
    ...
    private void readNumeroEndos(File imageFile) throws IOException {
        ...
        File tempFile = new File(pathimage + fichierimage + "s.jpg");
                   ...
                   FileUtils.copyFile(versoFile,new File(srvRemiseFilePath +  File.separator + fileRoot + "r.jpg"));
                    ...
                    if (renameSucceeded == 3) {
                       ...
                       String sql = "SELECT * FROM REMISES WHERE MACHINESCAN='" + repertoire.getPartenaire() + "' AND ETAT IN ("+Utility.getParam("CETAREMSTO")+","+Utility.getParam("CETAREMSAI")+") ORDER BY IDREMISE DESC";
                        ...
                        readCodeVignette(new File(pathimage + fichierimage + "f.jpg"));
                        readNumeroEndos(new File(pathimage + fichierimage +  "r.jpg"));
