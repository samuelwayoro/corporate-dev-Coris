 ...
 * @author Patrick
 */
public class Mailo3Reader extends BinFileReader  {
...
//MAJ ou INSERTION
            ...
            // getNumCheque est utilise pour recupere le valeur de getNumEffet
            //aEffet.setNumeroeffet(imageIndex.getNumEffet());     
             aEffet.setNumeroeffet(imageIndex.getNumCheque());
           // aEffet.setIban_Tire(imageIndex.getPfxIBANDeb());
            ...
            if (effets != null && effets.length > 0) {
               ...
               // db.updateRowByObjectByQuery(aEffet, "EFFETS", sql);
                 ...
                 sql = "UPDATE EFFETS SET PATHIMAGE='" + imagePath + "',FICHIERIMAGE='" + imageName + "', ETAT=" + Utility.getParam("CETAOPERETREC") + " WHERE IDEFFET=" + effets[0].getIdeffet();
                 db.executeUpdate(sql);
            } else {
