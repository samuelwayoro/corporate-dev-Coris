 ...
 * @author Patrick
 */
public class OutgoReader extends FlatFileReader {
    ...
    public File treatFile(File aFile, Repertoires repertoire) throws Exception {
        ...
        if (cptLot != enteteRemise.enteteLots.length) {
            System.out.println("WARNING: Nbre de Lot réel différent du nbr de lot marqué dans l'entete de remise.");
        }
                ...
                switch (Integer.parseInt(enteteLot1.getTypeOperation())) {
                    ...
                    case StaticValues.BLT_ORD_SCAN_SICA3: {
                       ...
                       // effet.setNumeroeffet(operation1.getNumIntOrdre());
                        ...
                        effet.setNumeroeffet(operation1.getNumIntOrdre().substring(3, 10));
                    ...
                    case StaticValues.REJ_PRELEVEMENT:
                    case StaticValues.REJ_PRELEVEMENT_SICA3: {
                        String sql = "SELECT * FROM PRELEVEMENTS WHERE RIO ='" + operation1.getRioOperInitial().getRio() + "'";
                        ...
                        if (prelevements != null && prelevements.length > 0) {
                            prelevements[0].setReference_Operation_Rejet(operation1.getRefOperation());
                            prelevements[0].setRio_Rejet(operation1.getRio().getRio());
                            prelevements[0].setEtat(new BigDecimal(Long.parseLong(Utility.getParam("CETAOPEREJRET"))));
                            prelevements[0].setMotifrejet(operation1.getMotifRejet());
                            prelevements[0].setRemcom(remcom.getIdremcom());
