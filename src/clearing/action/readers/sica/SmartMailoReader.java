 ...
 * @author Patrick
 */
public class SmartMailoReader extends BinFileReader {
    ...
    private void insertImageIndexIntoDB(DataBase db) throws SQLException {
        ...
        if (imageIndex.getTypeOperation().equals("030") || imageIndex.getTypeOperation().equals("035")) {
            ...
            aCheque.setMachinescan(ocrResult);
//MAJ ou INSERTION
    ...
    private void readCodeVignette(File imageFile) throws IOException {
       ...
       // BufferedImage partImage = fullImage.getSubimage(fullImage.getWidth() - 55, 55, 55, fullImage.getHeight() - 55);
        BufferedImage partImage = fullImage.getSubimage(630, 190, 1130-630, 90);
    ...
    public File treatFile(File aFile, Repertoires repertoire) {
        ...
        try {
            ...
            Logger.getLogger(SmartMailoReader.class.getName()).log(Level.INFO, null, ex);
            db.close();
        }
        return aFile;
    }

    public SmartMailoReader() {
