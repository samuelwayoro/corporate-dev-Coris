 ...
 * @author Patrick
 */
public class SmartChequeWithoutSlipCUTReader extends FlatFileReader {
    ...
    public SmartChequeWithoutSlipCUTReader() {
            ...
            if (!versoFileName.trim().isEmpty() && !dataFileName.trim().isEmpty() && !rectoFileName.trim().isEmpty()
...

                {
                    ...
                    if (versoFile.exists() && (new File(pathimage + fichierimage + "r.jpg")).exists()) {
                        ...
                        renameSucceeded++;
                        //Application du Tatoo
                        File newVersoFile = new File(pathimage + fichierimage + "r.jpg");
                        BufferedImage bimg = ImageIO.read(newVersoFile);
                        Boolean mayTattoo = true;
                        if (mayTattoo) {
                            Utility.tattooPictureFromDiskImage(bimg, newVersoFile);
                        }
