 ...
 * @author Patrick
 */
public class SystacRCPChequeRejetRetourReader extends FlatFileReader {

    public SystacRCPChequeRejetRetourReader() {
            ...
            if(compteur != 1){
                getChamp(1);
                    ...
                    String sql = "SELECT * FROM CHEQUES WHERE DATEEMISSION='" +cheque.getDateemission()+
                            ...
                            "' AND MONTANTCHEQUE ='" + cheque.getMontantcheque() + "' AND ETAT =" + Utility.getParam("CETAOPEALLICOM1") +
                            "";
