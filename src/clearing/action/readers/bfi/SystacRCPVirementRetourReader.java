 ...
 * @author Patrick
 */
public class SystacRCPVirementRetourReader extends FlatFileReader {

    public SystacRCPVirementRetourReader() {
    ...
    public File treatFile(File aFile, Repertoires repertoire) throws Exception {
        ...
        while ((line = is.readLine()) != null) {
            ...
            if (compteur != 1) {
                ...
                virement.setDatecompensation(Utility.convertDateToString(Utility.convertStringToDate(getChamp(8), "yyyyMMdd"), ResLoader.getMessages("patternDate")));
                getChamp(8);
                //getChamp(4);
                virement.setRemise(new BigDecimal(getChamp(4))) ;
                typeOperation = getChamp(2);
                virement.setDevise(getChamp(3));
                virement.setDevise("XAF");
                getChamp(2);
                ...
                virement.setNumerocompte_Tire(getChamp(11));
                getChamp(2);
                ...
                virement.setNumerocompte_Beneficiaire(getChamp(11));
                getChamp(2);
                virement.setNom_Beneficiaire(getChamp(30));
                virement.setReference_Emetteur(getChamp(20));
                getChamp(2);
