 ...
 * @author Patrick
 */
public class LotDeltaNumReader extends FlatFileReader {
    ...
    public File treatFile(File aFile, Repertoires repertoire) throws Exception {
        ...
        for (int j = 0; j < enteteLot1.operations.length; j++) {
            ...
            switch (Integer.parseInt(operation1.getTypeOperation())) {
                ...
                case StaticValues.REJ_CHQ_PAP: {
                    hasRejetCheque = true;
                    String sql = "SELECT * FROM CHEQUES WHERE RIO ='" + operation1.getRioOperInitial().getRio() + "' AND ETAT IN (" + Utility.getParam("CETAOPERETENVSIB") + "," + Utility.getParam("CETAOPERETRECENVSIB") + "," + Utility.getParam("CETAOPEALLICOM2") + ")";
                    Cheques[] cheques = (Cheques[]) db.retrieveRowAsObject(sql, new Cheques());
