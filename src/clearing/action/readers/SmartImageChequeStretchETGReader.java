 ...
 * @author Patrick
 */
public class SmartImageChequeStretchETGReader extends FlatFileReader  {
    ...
    public SmartImageChequeStretchETGReader() {
    ...
    public File treatFile(File aFile, Repertoires repertoire) throws Exception {
        ...
        if (sequence != null) {
            ...
            if (!versoFileName.trim().isEmpty() && !dataFileName.trim().isEmpty() && !rectoFileName.trim().isEmpty()&&
                ...
                if (dataFile.length()==0 || line.replaceAll("\\p{javaWhitespace}+", "").length() < Integer.parseInt(Utility.getParam("CMC7_MIN_LENGTH")))  {
                    is.close();
