 ...
 * @author Patrick
 */
public class SmartImageChequeLiteReader extends FlatFileReader  {
    ...
    public SmartImageChequeLiteReader() {
        ...
        if (sequence != null) {
            ...
            if (!versoFileName.trim().isEmpty() && !dataFileName.trim().isEmpty() && !rectoFileName.trim().isEmpty()&&
                ...
                if (dataFile.length() == 0 || (Utility.getParam("STRONG_CHECK_CMC7")!= null && Utility.getParam("STRONG_CHECK_CMC7").equals("1") && line.length() < Integer.parseInt(Utility.getParam("CMC7_MIN_LENGTH"))) ) {
                  ...
                  Utility.copyFile(rectoFile,new File(srvRemiseFilePath +  File.separator +  fileRoot + "f.jpg"));
                   ...
                   Utility.copyFile(versoFile,new File(srvRemiseFilePath +  File.separator + fileRoot + "r.jpg"));
                    ...
                    Utility.copyFile(rectoFile,new File(pathimage + fichierimage + "f.jpg"));
                    ...
                    //Utility.compressJpegFile(versoFile,new File(pathimage + fichierimage + "r.jpg"),0.3f);
                     Utility.copyFile(versoFile,new File(pathimage + fichierimage + "r.jpg"));
                   // File newVersoFile = new File(pathimage + fichierimage + "r.jpg");
                    if (versoFile.exists() && (new File(pathimage + fichierimage + "r.jpg")).exists()) {
                     ...
                     Utility.copyFile(dataFile,new File(pathimage + fichierimage + "d.txt"));
