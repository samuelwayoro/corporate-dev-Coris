 ...
 * @author Patrick
 */
public class ComptesBICIReader extends FlatFileReader {

    public ComptesBICIReader() {
    ...
    public File treatFile(File aFile, Repertoires repertoire) throws Exception {
        ...
        while ((line = is.readLine()) != null) {
            ...
            getChamp(18);
            action = getChamp(1);
            compte.setSignature1(getChamp(8));//Date de Creation du compte
            compte.setAdresse2(getChamp(4));// Code Gestionnaire
            if (getChamp(1).equalsIgnoreCase("O")) {
                compte.setEtat(new BigDecimal(Utility.getParam("CETAOPEANO")));
            } else {
                compte.setEtat(BigDecimal.ZERO);
            }
