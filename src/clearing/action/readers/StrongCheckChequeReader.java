 ...
 * @author Patrick
 */
public class StrongCheckChequeReader extends FlatFileReader  {
    ...
    public StrongCheckChequeReader() {
    ...
    public File treatFile(File aFile, Repertoires repertoire) throws Exception {
        ...
        if (sequence != null) {
            ...
            if (!versoFileName.trim().isEmpty() && !dataFileName.trim().isEmpty() && !rectoFileName.trim().isEmpty()&&
                ...
                boolean rExist = isFileAlreadyTreated(rectoFile);
                boolean vExist = isFileAlreadyTreated(dataFile);
                boolean dExist = isFileAlreadyTreated(versoFile);
                        ...
                        if (param != null) {
                            ...
                            if (param.equalsIgnoreCase("1")) {
                                ...
                                if(junkFolderName!=null){
                                    ...
                                    rectoFile.renameTo(new File(junkFolderName + File.separator + rectoFile.getName()));
                                    versoFile.renameTo(new File(junkFolderName + File.separator + versoFile.getName()));
                                    dataFile.renameTo(new File(junkFolderName + File.separator + dataFile.getName()));
                                }
