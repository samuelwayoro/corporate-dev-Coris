 ...
 */
public class OUTGOToCROESNReader extends FlatFileReader {

/**
     * Creates a new instance of OUTGOToCROReader
     */
    public OUTGOToCROESNReader()
    {
 ...
 @Override
    public File treatFile(File aFile, Repertoires repertoire) throws Exception {
       ...
       new CroUAPESNWriter().execute();
       new RejetSicaChequeCorporatesWriter().execute();
