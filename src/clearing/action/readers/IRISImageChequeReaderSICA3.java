 ...
 * @author Patrick
 */
public class IRISImageChequeReaderSICA3 extends FlatFileReader {
    ...
    public IRISImageChequeReaderSICA3() {
            ...
            if (versoFile.exists() && dataFile.exists()) {
                ...
                if (line != null) {
                    if (line.startsWith("C")) {
                        setCurrentLine(line);
                        getChamp(1);
                        String compteRemettant = getChamp(12);
                        ...
                        if (renameSucceeded == 2) {
                            ...
                            aRemise.setMachinescan(repertoire.getId());
                        ...
                        getChamp(1);
                        aCheque.setCompteremettant(getChamp(12).trim().replaceAll("\\p{Punct}", "_"));
                        is.close();
                        ...
                        if (renameSucceeded == 3) {
                            ...
                            if (comptes != null) {
                                ...
                                aCheque.setMachinescan(repertoire.getId());
                                ...
                                if (aCheque.getNumerocheque().contains("_") || aCheque.getBanque().contains("_") || aCheque.getAgence().contains("_") || aCheque.getNumerocompte().contains("_")) {
                                    aCheque.setEtat(new BigDecimal(Utility.getParam("CETAOPEERR")));
                                }
                                if (aCheque.getType_Cheque().equalsIgnoreCase("030")) {
                                    aCheque.setEtat(new BigDecimal(Utility.getParam("CETAOPEERR")));
                                }
