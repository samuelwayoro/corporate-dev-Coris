 ...
 * @author Patrick
 */
public class SmartChequeWithoutSlipReader extends FlatFileReader {
    ...
    public SmartChequeWithoutSlipReader() {
        ...
        if (sequence != null) {
            ...
            if (!versoFileName.trim().isEmpty() && !dataFileName.trim().isEmpty() && !rectoFileName.trim().isEmpty()
...

                {
                    ...
                    if (Utility.getParam("CORP_ORABANK") != null && Utility.getParam("CORP_ORABANK").equals("0")) {

                        if (aCheque.getNumerocompte() == null || !NumberUtils.isNumber(aCheque.getNumerocompte()) || aCheque.getNumerocompte().isEmpty()) {
                            aCheque.setNumerocompte("000000000000");
                        }
                    }
                    is.close();
