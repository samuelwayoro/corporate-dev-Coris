 ...
 * @author Patrick
 */
public class SystacENVChequeAllerRejWriter extends FlatFileWriter{

    public SystacENVChequeAllerRejWriter() {
    }
    ...
    @Override
       public void execute() throws Exception {
        ...
        String sql = "SELECT * FROM CHEQUES WHERE ETAT IN (" +  Utility.getParam("CETAOPEALLICOM2")  + ") AND BANQUE LIKE '10%'";
        ...
        long sumCheques = 0;
         ...
         String line = "101CM";
            ...
            for (int i = 0; i < cheques.length; i ++) {
                ...
                line += Utility.convertDateToString(new Date(System.currentTimeMillis()), "yyyyMMdd");
                line += Utility.convertDateToString(new Date(System.currentTimeMillis()), "yyyyMMdd");
                line += Utility.bourrageDZero(cheque.getMotifrejet(), 8);
                line += createBlancs(9, " ");
