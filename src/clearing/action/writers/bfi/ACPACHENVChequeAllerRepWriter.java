 ...
 * @author Patrick
 */
public class ACPACHENVChequeAllerRepWriter extends FlatFileWriter {

    public ACPACHENVChequeAllerRepWriter() {
...
//                + "-" + heureFichier + "-33-21-950.ENV";
        ...
        String sql = "SELECT * FROM CHEQUES WHERE ETAT IN (" + Utility.getParam("CETAOPEALLICOM1REP") + ") "
                + " AND BANQUE<>BANQUEREMETTANT  ORDER BY BANQUE, AGENCE, IDCHEQUE ";
