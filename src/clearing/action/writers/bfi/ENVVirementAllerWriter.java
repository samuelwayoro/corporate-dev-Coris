 ...
 * @author Patrick
 */
public class ENVVirementAllerWriter extends FlatFileWriter{

    public ENVVirementAllerWriter() {
    }
         ...
         String line = "101GN";
            ...
            for (int i = 0; i < virements.length; i ++) {
                ...
                if(virement.getEtat().toPlainString().equals(Utility.getParam("CETAOPEALLICOM1"))){
                    virement.setEtat(new BigDecimal(Utility.getParam("CETAOPEALLICOM1ACC")));
