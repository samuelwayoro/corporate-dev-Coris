 ...
 * @author Patrick
 */
public class ENVVirementAllerAnnRejWriter extends FlatFileWriter{

    public ENVVirementAllerAnnRejWriter() {
    }
    ...
    @Override
       public void execute() throws Exception {
        ...
        String fileName = Utility.getParam("SIB_IN_FOLDER") + File.separator + "01-GN-"+ Utility.getParam("CODE_BANQUE")+"-"+ dateFichier
                          + "-" + heureFichier +"-10-24-324.ENV";
        setOut(createFlatFile(fileName));

        String sql = "SELECT * FROM VIREMENTS WHERE ETAT IN (" +  Utility.getParam("CETAOPEALLICOM2ACC")  + ") ";
        ...
        long sumVirements = 0;
         ...
         String line = "101GN";
            ...
            for (int i = 0; i < virements.length; i ++) {
                ...
                wwriteln(line);
                if(virement.getEtat().toPlainString().equals(Utility.getParam("CETAOPEALLICOM2ACC"))){
                    virement.setEtat(new BigDecimal(Utility.getParam("CETAOPEALLICOM2ANN")));
