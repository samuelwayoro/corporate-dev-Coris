...
public class ACPACHENVChequeAllerAnnSRGWriter extends FlatFileWriter {
    ...
    public ACPACHENVChequeAllerAnnSRGWriter() {
        setDescription("Envoi des Cheques Aller regionaux Annulés.  vers ACP/ACH");
    }
...
//                + "-" + heureFichier + "-30-23-950.ENV";
        ...
        if (cheques != null && 0 < cheques.length) {
            ...
            setDescription(getDescription() + " exécuté avec succès:\n Nombre de Cheques Regionaux annulés= " + cheques.length + " - Montant Total= " + Utility.formatNumber("" + sumCheques) + " - Nom de Fichier = " + fileName);
            logEvent("INFO", "Nombre de Cheques Regionaux annulés= " + cheques.length + " - Montant Total= " + Utility.formatNumber("" + sumCheques));
            closeFile();
        } else {
