 ...
 * @author Patrick
 */
public class LotDeltaNewCBAOWriter extends FlatFileWriter {
...
//        db.executeUpdate("UPDATE CHEQUES SET ETAT=" + Utility.getParam("CETAOPEVAL") + " WHERE ETAT=" + Utility.getParam("CETAOPEVAL")
//                + " AND REMISE IN (SELECT IDREMISE FROM REMISES WHERE ETAT=" + Utility.getParam("CETAOPEVAL") + ")");
        db.executeUpdate("UPDATE CHEQUES SET ETAT=" + Utility.getParam("CETAOPEVAL") + " WHERE ETAT=" + Utility.getParam("CETAOPESAI")
                + " AND REMISE IN (SELECT IDREMISE FROM REMISES WHERE ETAT=" + Utility.getParam("CETAOPEVAL") + ")");
//        db.executeUpdate("UPDATE REMISES SET ETAT=" + Utility.getParam("CETAOPEVAL") + " WHERE ETAT=" + Utility.getParam("CETAOPEVAL")
//                + " AND IDREMISE IN (SELECT REMISE FROM CHEQUES WHERE ETAT=" + Utility.getParam("CETAOPEVAL") + ")");
    ...
    private void feedOperationWithCheque35(int j, Cheques cheque, Operation[] operations) {
        ...
        try {
            ...
            Logger.getLogger(LotDeltaNewCBAOWriter.class.getName()).log(Level.SEVERE, null, ex);
        }
