 ...
 * @author Patrick
 */
public class LotDeltaCBAOCompensWriter extends FlatFileWriter {
    ...
    public LotDeltaCBAOCompensWriter() {
    ...
    private void feedOperationWithCheque35(int j, Cheques cheque, Operation[] operations) {
        ...
        try {
            ...
            Logger.getLogger(LotDeltaCBAOCompensWriter.class.getName()).log(Level.SEVERE, null, ex);
        }
