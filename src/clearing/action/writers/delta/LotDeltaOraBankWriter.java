 ...
 * @author Patrick
 */
public class LotDeltaOraBankWriter extends FlatFileWriter {
    ...
    private void feedOperationWithCheque35(int j, Cheques cheque, Operation[] operations) {
        ...
        try {
            ...
            Logger.getLogger(LotDeltaOraBankWriter.class.getName()).log(Level.SEVERE, null, ex);
        }
