 ...
 * @author Patrick
 */
public class LotDeltaCBAOCaisseWriter extends FlatFileWriter {
    ...
    public LotDeltaCBAOCaisseWriter() {
    ...
    public void execute() throws Exception {
        ...
        String whereClause = " ETAT=" + Utility.getParam("CETAOPEVAL2")+" AND BANQUE  IN ('" + CMPUtility.getCodeBanque() + "','" + CMPUtility.getCodeBanqueSica3() + "') ";
    ...
    private void feedOperationWithCheque35(int j, Cheques cheque, Operation[] operations) {
        ...
        try {
            ...
            Logger.getLogger(LotDeltaCBAOCaisseWriter.class.getName()).log(Level.SEVERE, null, ex);
        }
