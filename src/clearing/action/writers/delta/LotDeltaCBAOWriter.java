 ...
 * @author Patrick
 */
public class LotDeltaCBAOWriter extends FlatFileWriter {
    ...
    private void feedOperationWithCheque35(int j, Cheques cheque, Operation[] operations) {
        ...
        try {
            ...
            Logger.getLogger(LotDeltaCBAOWriter.class.getName()).log(Level.SEVERE, null, ex);
        }
