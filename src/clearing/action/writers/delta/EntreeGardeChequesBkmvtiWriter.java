 ...
 * @author Patrick
 */
public class EntreeGardeChequesBkmvtiWriter extends FlatFileWriter {

    public EntreeGardeChequesBkmvtiWriter() {
        setDescription("Envoi des cheques du Garde Cheque vers le SIB");
    }
...
// Population
        String sql = "SELECT * FROM CHEQUES WHERE ETAT IN (" + Utility.getParam("CETAOPEGARCHECON") + ") AND CALCUL=1";
        ...
        if (cheques != null && 0 < cheques.length) {
            ...
            for (int i = 0; i < cheques.length; i ++) {
                    ...
                    try{
                        ...
                        setDescription(getDescription() +" Compte "+Utility.bourrageGauche(bkcom[0].getCompte(), 11, "0")+" non trouvé dans bkcom");
                    ...
                    line.append("|C|");
                    line.append("Remise Cheque "+cheques[i].getNumerocheque());
                    line.append("|N|");
                    ...
                    if(cheques[i].getEtat().toPlainString().equals(Utility.getParam("CETAOPEGARCHECON"))){
                    cheques[i].setEtat(new BigDecimal(Utility.getParam("CETAOPEGARCHECONSIB")));
