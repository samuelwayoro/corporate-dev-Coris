 ...
 * @author Patrick
 */
public class ChequeRetourNSIASitWriter extends FlatFileWriter {

    public ChequeRetourNSIASitWriter() {
    ...
    public void execute() throws Exception {
        ...
        if (cheques != null && 0 < cheques.length) {
            ...
            for (int i = 0; i < cheques.length; i++) {
                ...
                line += "00"+cheque.getBanqueremettant();
                line += createBlancs(2, " ") + "2";
                line += CMPUtility.getAgenceACP(cheque.getBanqueremettant(),cheque.getAgenceremettant());
                ...
                line += "00"+cheque.getBanque();
                line +=  CMPUtility.getAgenceACP(cheque.getBanque(),cheque.getAgence());
                //line += cheque.getRibcompte();
                line += Utility.computeCleRIB("00"+cheque.getBanque(), CMPUtility.getAgenceACP(cheque.getBanque(),cheque.getAgence()),Utility.bourrageGauche(cheque.getNumerocompte(), 12, "0"));
