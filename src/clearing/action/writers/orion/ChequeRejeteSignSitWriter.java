 ...
 * @author Patrick
 */
public class ChequeRejeteSignSitWriter extends FlatFileWriter {

    public ChequeRejeteSignSitWriter() {
    ...
    @Override
       public void execute() throws Exception {
        ...
        String sql = "SELECT * FROM CHEQUES WHERE ETAT IN (" +  Utility.getParam("CETAOPEALLICOM2ACC")  + ") AND LOTSIB = 0  ";
