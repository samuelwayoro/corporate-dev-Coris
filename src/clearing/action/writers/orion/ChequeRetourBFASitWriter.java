 ...
 * @author Patrick
 */
public class ChequeRetourBFASitWriter extends FlatFileWriter {

    public ChequeRetourBFASitWriter() {
    ...
    public void execute() throws Exception {
        ...
        if (cheques != null && 0 < cheques.length) {
            ...
            for (int i = 0; i < cheques.length; i++) {
                ...
                line += "0" + createBlancs(7, " ") + "0" + createBlancs(2, " ") + createBlancs(6, "0") + createBlancs(4, "b") + createBlancs(1, " ")+"0001";
                line += Utility.bourrageGZero(cheque.getIdcheque().toPlainString(), 6);
                line += createBlancs(68, " ");
