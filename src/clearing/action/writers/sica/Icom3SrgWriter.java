 ...
 * @author Patrick
 */
public class Icom3SrgWriter extends FlatFileWriter {
    ...
    public Icom3SrgWriter() {
        setDescription("Envoi ICOM3 Sous Regional vers la BCEAO ");
    }
    ...
    public void execute() throws Exception {
        ...
        if (Utility.getParam("ENVOI_ICOM_SRG") == null || Utility.getParam("ENVOI_ICOM_SRG").equals("0")) {
            ...
            logEvent("WARNING", "Un ICOM3 est en cours d'envoi|ENVOI_ICOM_SRG=1");
            setDescription(getDescription() + " - WARNING: Un ICOM3 est en cours d'envoi|ENVOI_ICOM_SRG=1");
        }
    ...
    public void annulationTotale(DataBase db) {
        String whereClause = " AND IDEMETTEUR IN ('SNSSR','KSCSR')";
        ...
        if (remcoms != null && remcoms.length > 0) {
            ...
            if (lotcoms != null && lotcoms.length > 0) {
                ...
                if (cheques != null && cheques.length > 0) {
                    ...
                    for (int i = 0; i < cheques.length; i += j) {
                        ...
                        try {
                            ...
                            Logger.getLogger(Icom3SrgWriter.class.getName()).log(Level.SEVERE, null, ex);
                ...
                // sql = "SELECT * FROM VIREMENTS WHERE ETAT = " + Utility.getParam("CETAOPEALLICOM3") + " AND TYPE_VIREMENT ='" + Utility.getParam("VIRSTACLINOUNOR") + "'  ORDER BY LOTCOM";
                ...
                //   sql = "SELECT * FROM VIREMENTS WHERE ETAT = " + Utility.getParam("CETAOPEALLICOM3") + " AND TYPE_VIREMENT ='" + Utility.getParam("VIRBANBANANCNOR") + "'  ORDER BY LOTCOM";
                virements = (Virements[]) db.retrieveRowAsObject(sql, new Virements());
                j = 0;
                if (virements != null && virements.length > 0) {
                    remcomValue = virements[0].getRemcom();
                ...
                //  sql = "SELECT * FROM VIREMENTS WHERE ETAT = " + Utility.getParam("CETAOPEALLICOM3") + " AND TYPE_VIREMENT ='" + Utility.getParam("VIRMISDISNOUNOR") + "'  ORDER BY LOTCOM";
                virements = (Virements[]) db.retrieveRowAsObject(sql, new Virements());
                j = 0;
                if (virements != null && virements.length > 0) {
                    remcomValue = virements[0].getRemcom();
                ...
                //sql = "SELECT * FROM EFFETS WHERE ETAT = " + Utility.getParam("CETAOPEALLICOM3") + " AND TYPE_EFFET ='" + Utility.getParam("BILORDNOUNOR") + "'  ORDER BY LOTCOM";
                ...
                //  sql = "SELECT * FROM EFFETS WHERE ETAT = " + Utility.getParam("CETAOPEALLICOM3") + " AND TYPE_EFFET ='" + Utility.getParam("LETCHANOUNOR") + "'  ORDER BY LOTCOM";
                effets = (Effets[]) db.retrieveRowAsObject(sql, new Effets());
                j = 0;
                if (effets != null && effets.length > 0) {
                    remcomValue = effets[0].getRemcom();
                ...
                // sql = "SELECT * FROM PRELEVEMENTS WHERE ETAT = " + Utility.getParam("CETAOPEALLICOM3") + " AND TYPE_PRELEVEMENT ='025'  ORDER BY LOTCOM";
