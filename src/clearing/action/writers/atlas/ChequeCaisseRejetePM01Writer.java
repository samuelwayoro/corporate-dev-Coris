...
import static clearing.action.writers.atlas.ChequeAllerRejetePM01Writer.priseCommission;
 ...
 * @author Patrick
 */
public class ChequeCaisseRejetePM01Writer extends FlatFileWriter {

    public ChequeCaisseRejetePM01Writer() {
...
// Population
        ...
        if (cheques != null && 0 < cheques.length) {
            ...
            String cptComptable, codeMouvement, refDenotage, libelleComptable, type;
            ...
            for (Cheques cheque : cheques) {
                ...
                if (priseCommission) {
                    ...
                    type = "0";
                    if (!createLinePM01(cptComptable, Long.parseLong(Utility.getParam("MNTFRAREJCHQ")), dateValeur, codeMouvement, refDenotage, libelleComptable, type)) {
                        return;
                    }
