 ...
 * @author Patrick
 */
public class ExportAllerAtlasMLWriter extends FlatFileWriter {

    public ExportAllerAtlasMLWriter() {
                        ...
                        for (int x = 0; x < chequesVal.length; x++) {
                            ...
                            if (CMPUtility.isBanqueNationale(aCheque.getBanque())) {
                                if (aCheque.getBanque().equalsIgnoreCase(Utility.getParam("CODE_BANQUE_SICA3"))) {
                                    ...
                                    if (aCheque.getEscompte().equals(new BigDecimal(2))) {
                                        typeCheque = "11";
                                    }
                                } else {
                                    typeCheque = "05";
                            ...
                            //mise a jour
                            line = remises[0].getAgenceDepot().trim() + ";"
