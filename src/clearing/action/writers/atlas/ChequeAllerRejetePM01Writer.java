 ...
 * @author Patrick
 */
public class ChequeAllerRejetePM01Writer extends FlatFileWriter {

    public ChequeAllerRejetePM01Writer() {
...
//                db.updateRowByObjectByQuery(cheque, "CHEQUES", "IDCHEQUE=" + cheque.getIdcheque());
    ...
    public static boolean priseCommission(Cheques cheque) {
        if (cheque.getMotifrejet().equals("101")
                || cheque.getMotifrejet().equals("203")
                || cheque.getMotifrejet().equals("208")
                || cheque.getMotifrejet().equals("215")
                || cheque.getMotifrejet().equals("216")) {
            return false;
        } else {
            return true;
        }
