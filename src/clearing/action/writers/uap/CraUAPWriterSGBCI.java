 ...
 * @author Patrick
 */
public class CraUAPWriterSGBCI extends FlatFileWriter {
    ...
    public void execute() throws Exception {
        ...
        source = (remcom.getIdrecepteur().substring(2).equalsIgnoreCase(Utility.getParam("CONSTANTE_SICA"))) ? "000" : "001";
       
        String whereClause = " REMCOM = " + remcom.getIdremcom() + " AND ETAT = " + remcom.getEtat();

        if (remcom.getEtat().equals(new BigDecimal(Utility.getParam("CETAOPEALLICOM1ACC")))) {
        ...
        if (remcom.getEtat().equals(new BigDecimal(Utility.getParam("CETAOPEALLICOM2ACC")))) {
    ...
    private String printLotRejets(EnteteLot enteteLot) throws Exception {
        ...
        String fileName = Utility.getParam("SIB_IN_FOLDER") + File.separator + CMPUtility.getCodeBanqueSica3() + "." + source + "." + sequenceLot + "." + enteteLot.getTypeOperation() + "." + CMPUtility.getDevise() + ".CRA"; //+CMPUtility.getDate()+".done";
    ...
    public void printLotVirement(Virements[] virements, EnteteLot enteteLot) throws Exception {
        ...
        String fileName = Utility.getParam("SIB_IN_FOLDER") + File.separator + virements[0].getBanqueremettant() + "." + source + "." + sequenceLot + "." + enteteLot.getTypeOperation() + "." + CMPUtility.getDevise() + ".CRA"; //+CMPUtility.getDate()+".done";
        setOut(createFlatFile(fileName));
    ...
    public void printLotCheque(Cheques[] cheques, EnteteLot enteteLot) throws Exception {
        ...
        String fileName = Utility.getParam("SIB_IN_FOLDER") + File.separator + cheques[0].getBanqueremettant() + "." + source + "." + sequenceLot + "." + enteteLot.getTypeOperation() + "." + CMPUtility.getDevise() + ".CRA"; //+CMPUtility.getDate()+".done";
        setOut(createFlatFile(fileName));
    ...
    public void printLotEffet(Effets[] effets, EnteteLot enteteLot) throws Exception {
        ...
        String fileName = Utility.getParam("SIB_IN_FOLDER") + File.separator + effets[0].getBanqueremettant() + "." + source + "." + sequenceLot + "." + enteteLot.getTypeOperation() + "." + CMPUtility.getDevise() + ".CRA"; //+CMPUtility.getDate()+".done";
        setOut(createFlatFile(fileName));
