 ...
 * @author Patrick
 */
public class CroUAPNSIAWriterOLD1 extends FlatFileWriter {
    ...
    private void updateEtatOperations(DataBase db) throws SQLException {
        ...
        if (remiseHasCheques) {
            l_sql = "UPDATE CHEQUES SET ETAT=" + Utility.getParam("CETAOPERETENVSIB") + ", LOTSIB = null WHERE ETAT = " + Utility.getParam("CETAOPERET"); //Mise ajour
            db.executeUpdate(l_sql);
            l_sql = "UPDATE CHEQUES SET ETAT=" + Utility.getParam("CETAOPERETRECENVSIB") + ",LOTSIB =null WHERE ETAT = " + Utility.getParam("CETAOPERETREC");//170
            db.executeUpdate(l_sql);
