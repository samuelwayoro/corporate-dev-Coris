 ...
 * @author Patrick
 */
public class CroUAPNSIAWriter extends FlatFileWriter {
    ...
    private String printLotRejets(EnteteLot enteteLot) throws Exception {
        ...
        for (int j = 0; j < enteteLot.operations.length; j++) {
            ...
            line = new String(
                    ...
                    + ((Utility.getParam("WDB_MODE") != null && Utility.getParam("WDB_MODE").equalsIgnoreCase("REPORT"))|| "145|146".contains(enteteLot.getTypeOperation())
