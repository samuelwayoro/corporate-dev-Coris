 ...
 * @author Patrick
 */
public class CroUAPTPCIWriter extends FlatFileWriter {
    ...
    public void execute() throws Exception {
        ...
        if (refLot > 0) {
            ...
            updateEtatOperations(db);
             ...
             logEvent("INFO", "Nombre d'opérations " + vEnteteLots.get(i).getTypeOperation() +" -> "+vEnteteLots.get(i).getNbOperations());
            }
    ...
    private void feedOperationWithPrelevement(int j, Operation[] operations, Prelevements prelevement) {
        ...
        operations[j].setRefEmetteur(prelevement.getReference_Emetteur());
    ...
    private void preparePrelevements(Prelevements[] prelevements) throws SQLException, Exception {
    ...
    private String printPrelevements(EnteteLot enteteLot, int j) {
       StringBuilder lineBuilder = new StringBuilder();
        ...
        lineBuilder.append(enteteLot.operations[j].getRefEmetteur());
