 ...
 * @author Patrick
 */
public class CraUAPCorisWriter extends FlatFileWriter {
    ...
    public void execute() throws Exception {
        ...
        source = (remcom.getIdemetteur().substring(2).equalsIgnoreCase(Utility.getParam("CONSTANTE_SICA"))) ? "000" : "001";
