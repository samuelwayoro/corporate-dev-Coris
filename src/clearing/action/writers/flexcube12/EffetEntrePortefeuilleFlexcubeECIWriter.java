 ...
 * @author hp
 */
public class EffetEntrePortefeuilleFlexcubeECIWriter extends FlatFileWriter {


    public EffetEntrePortefeuilleFlexcubeECIWriter() {
...
//        String fileName = Utility.getParam("SIB_IN_FOLDER") + File.separator + Utility.getParam("CPTENV_FILE_ROOTNAME") + compteur + Utility.getParam("SIB_FILE_EXTENSION");
        ...
        if (effets != null && 0 < effets.length) {
            ...
            //pour avoir le montant globale des effets saisie et validés
            sql = "SELECT * FROM EFFETS WHERE ETAT IN (" + Utility.getParam("CETAOPESUPVAL") + ")  ORDER BY REMISE";
            ...
            detbUploadDetail.setADDL_TEXT(Utility.getParam("LIBATTEFFETENTREFLEX1"));//Réception de effets
