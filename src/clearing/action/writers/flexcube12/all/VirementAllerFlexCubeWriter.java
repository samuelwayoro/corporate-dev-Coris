 ...
 * @author Patrick
 */
public class VirementAllerFlexCubeWriter extends FlatFileWriter {

    public VirementAllerFlexCubeWriter() {
...
//     String fileName = Utility.getParam("SIB_IN_FOLDER") + File.separator + Utility.getParam("CHQ_IN_FILE_ROOTNAME") + compteur + Utility.getParam("SIB_FILE_EXTENSION");
        ...
        // fileName = Utility.getParam("SIB_IN_FOLDER") + File.separator + Utility.getParam("VIR_IN_FILE_ROOTNAME") + compteur + Utility.getParam("SIB_FILE_EXTENSION");
        fileName = Utility.getParam("SIB_IN_FOLDER") + File.separator + Utility.getParam("VIR_IN_FILE_ROOTNAME") + dateTraitement + "_" + numeroBatch + Utility.getParam("SIB_FILE_SQL_EXTENSION");

        sql = "SELECT * FROM VIREMENTS WHERE ETAT IN (" + Utility.getParam("CETAOPEALLICOM1ACC") + ") ";
        ...
        if (virements != null && 0 < virements.length) {
            ...
            for (int i = 0; i < virements.length; i++) {
                ...
                line.append(Utility.bourrageDroite(virement.getLibelle(), 194, " "));
                ...
                line.append(Utility.bourrageGZero(virement.getIdvirement().toPlainString(), 8));
                  ...
                  /**
                        ...
                        detbUploadDetail.setACCOUNT_BRANCH(compteFlexCube != null ? compteFlexCube.getAdresse2().trim() : Utility.getParam("TXN_BRANCH").charAt(0) + virement.getAgenceremettant().substring(3));//agence du compte  cc
                        ...
                        detbUploadDetail.setADDL_TEXT(dateValeur + " " + Utility.bourrageDroite(virement.getLibelle().trim() + " " + Utility.bourrageGauche(virement.getIdvirement()+ "", 8, "0"), 194, " "));
...
// Gestion cpt globalisation
            ...
            detbUploadDetail.setADDL_TEXT(CMPUtility.getDate() + " " + Utility.getParam("LIBVIRALEFLEX1")+ " "+Utility.convertDateToString(Utility.convertStringToDate(dateCompensation, "yyyy/mm/dd"), "dd/mm/yy"));
