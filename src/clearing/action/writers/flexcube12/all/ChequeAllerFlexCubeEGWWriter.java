 ...
 * @author Patrick
 */
public class ChequeAllerFlexCubeEGWWriter extends FlatFileWriter {

    public ChequeAllerFlexCubeEGWWriter() {
...
// Population
        ...
        if (cheques != null && 0 < cheques.length) {
            ...
            for (int i = 0; i < cheques.length; i += j) {
                ...
                if (chequesVal != null && 0 < chequesVal.length) {
                    ...
                    for (int x = 0; x < chequesVal.length; x++) {
                        ...
                        detbUploadDetail.setADDL_TEXT(dateValeur + Utility.bourrageGauche(aCheque.getRemise() + "", 7, "0") + " " + Utility.getParam("LIBCHQALEFLEX1") + Utility.bourrageGauche(aCheque.getNumerocheque() + "", 7, "0") + Utility.bourrageGauche(aCheque.getIdcheque() + "", 8, "0"));
            ...
            line.append(Utility.bourrageDroite(Utility.getParam("CPTATTCHQALEFLEX"), 16, " ")); //Utility.bourrageDroite(CMPUtility.getNumCptEx(cheque.getNumerocompte(), cheque.getAgence()), 16, " ")
