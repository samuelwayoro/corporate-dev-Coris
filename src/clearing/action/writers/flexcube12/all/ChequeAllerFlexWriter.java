...
public class ChequeAllerFlexWriter extends FlatFileWriter {
    ...
    public void execute() throws Exception {
         ...
         * FIN PARAM F12
         */
//        fileName = Utility.getParam("SIB_IN_FOLDER") + File.separator + Utility.getParam("CHQ_IN_FILE_ROOTNAME") + compteur + Utility.getParam("SIB_FILE_EXTENSION");

// Population
        sql = "SELECT * FROM CHEQUES WHERE ETAT=" + Utility.getParam("CETAOPEALLICOM1ACC") + " ORDER BY REMISE";
