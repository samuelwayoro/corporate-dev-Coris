    ...
    public void execute() throws Exception {
        ...
        if (virements != null && 0 < virements.length) {
            ...
            for (int i = 0; i < virements.length; i++) {
                ...
                line.append(Utility.bourrageDroite(CMPUtility.getNumCptEx(virement.getNumerocompte_Beneficiaire(), virement.getAgence(), "1"), 16, " "));
                ...
                detbUploadDetail.setADDL_TEXT(dateValeur + Utility.bourrageDroite(Utility.getParam("LIBVIRRETFLEX1").trim() + " " + virement.getBanqueremettant() + " D/O " + virement.getNom_Tire().trim() + " " + virement.getLibelle(), 194, " "));
...
// Gestion cpt globalisation
            ...
            detbUploadDetail.setADDL_TEXT(dateValeur + Utility.bourrageDroite(Utility.getParam("LIBCHQALEFLEX2"), 25, " "));
            detbUploadDetail.setREL_CUST((Utility.getParam("CPTDEBVIRRET").length() == 16) ? Utility.getParam("CPTDEBVIRRET").substring(6, 14) : "999999992");
