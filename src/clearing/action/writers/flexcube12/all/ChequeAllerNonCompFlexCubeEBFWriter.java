...
public class ChequeAllerNonCompFlexCubeEBFWriter extends FlatFileWriter {
    ...
    public ChequeAllerNonCompFlexCubeEBFWriter() {
        setDescription("Envoi des chèques vers le SIB ChequeAllerNonCompFlexCubeEBFWriter");
    }
...
//Creation ligne de chèque
    ...
    private void createEnteteSQL() {
        ...
        line.append("LOAD DATA\n"
                ...
                + " Trailing Nullcols\n"
                + " (FIN_CYCLE,PERIOD_CODE,VALUE_DATE DATE \"" + Utility.getParam("DATE_FORMAT") + "\"s,ADDL_TEXT,BRANCH_CODE,SOURCE_CODE,ACCOUNT_BRANCH,ACCOUNT,TXN_CODE,BATCH_NO, "
