 ...
 * @author Patrick
 */
public class ChequeAllerFlexCubeEBJWriter extends FlatFileWriter {

    public ChequeAllerFlexCubeEBJWriter() {
...
//     String fileName = Utility.getParam("SIB_IN_FOLDER") + File.separator + Utility.getParam("CHQ_IN_FILE_ROOTNAME") + compteur + Utility.getParam("SIB_FILE_EXTENSION");
        ...
        System.out.println("ChequeAllerFlexCubeEBJWriter cheques " + cheques.length);
        int j = 0;
        long montantTotal = 0;
        ...
        if (cheques != null && 0 < cheques.length) {
            ...
            for (int i = 0; i < cheques.length; i += j) {
                ...
                sql = "SELECT * FROM CHEQUES WHERE REMISE=" + cheques[i].getRemise() + " AND ETAT"
                        + " IN (" + Utility.getParam("CETAOPEALLICOM1ACC") + "," + Utility.getParam("CETAOPEREJRET") + "," + Utility.getParam("CETAOPEREJRETENVSIB") + ") "
                ...
                if (chequesVal != null && 0 < chequesVal.length) {
                    ...
                    for (int x = 0; x < chequesVal.length; x++) {
                        ...
                        line.append(Utility.bourrageDroite(CMPUtility.getNumCptEx(aCheque.getCompteremettant(), aCheque.getAgenceremettant(), "1"), 16, " "));
...
//                        line.append(Utility.bourrageGauche(aCheque.getRemise() + "", 7, "0"));
                        ...
                        detbUploadDetail.setADDL_TEXT(dateValeur + " " + Utility.bourrageDroite(nomEmetteur.trim() + " " + Utility.getParam("LIBCHQALEFLEX1") + " " + Utility.bourrageGauche(aCheque.getNumerocheque() + "", 7, "0"), 100, " "));
