 ...
 * @author Patrick
 */
public class ChequeAllerFlexCubeEMLWriter extends FlatFileWriter {

    public ChequeAllerFlexCubeEMLWriter() {
        ...
        if (cheques != null && 0 < cheques.length) {
            ...
            for (int i = 0; i < cheques.length; i += j) {
                ...
                if (chequesVal != null && 0 < chequesVal.length) {
                    ...
                    sql = "SELECT * FROM REMISES WHERE IDREMISE=" + aCheque.getRemise();
                    ...
                    for (int x = 0; x < chequesVal.length; x++) {
                        ...
                        line.append(Utility.bourrageDroite(CMPUtility.getNumCptExAgence(aCheque.getCompteremettant(), aCheque.getAgenceremettant()), 3, " "));
                        ...
                        line.append(Utility.bourrageDroite("BD " + remises[0].getReference() + " CHQ" + " " + Utility.bourrageGauche(aCheque.getNumerocheque() + "", 7, "0"), 90, " "));
                        ...
                        detbUploadDetail.setADDL_TEXT(dateValeur + Utility.bourrageGauche(aCheque.getRemise() + "", 7, "0") + " " + Utility.bourrageDroite("BD " + remises[0].getReference() + " CHQ" + " " + Utility.bourrageGauche(aCheque.getNumerocheque() + "", 7, "0"), 90, " "));
            ...
            detbUploadDetail.setADDL_TEXT(CMPUtility.getDate() + "CMPALL DU " + Utility.convertDateToString(Utility.convertStringToDate(dateCompensation, "yyyy/mm/dd"), "dd/mm/yy"));
