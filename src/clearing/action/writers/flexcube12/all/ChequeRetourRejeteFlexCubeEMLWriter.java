 ...
 * @author Patrick
 */
public class ChequeRetourRejeteFlexCubeEMLWriter extends FlatFileWriter {

    public ChequeRetourRejeteFlexCubeEMLWriter() {
    ...
    public void execute() throws Exception {
        ...
        if (cheques != null && 0 < cheques.length) {
            ...
            for (int i = 0; i < cheques.length; i++) {
                ...
                detbUploadDetail.setTXN_CODE("Q50");//Code transaction TXN_CODE
                ...
                if (cheque.getMotifrejet().equalsIgnoreCase("205") || cheque.getMotifrejet().equalsIgnoreCase("206")) {
                    ...
                    line.append(createBlancs(4, " "));
                    line.append("D");
                    line.append(Utility.bourrageGauche(Utility.getParamOfType("COMDEBREJSIGNCHQRET" + pers + "FLEX", "CODE_COMMISSION"), 16, " "));
                    line.append("F03");
                    line.append(dateValeur);
                    line.append(Utility.bourrageGauche(cheque.getNumerocheque(), 8, " "));
                    line.append(Utility.bourrageDroite(Utility.getParam("LIBREJCHQRETFLEX1"), 25, " "));
                    ...
                    detbUploadDetail.setDR_CR("D");//DR_CR Sens D ou C
                    detbUploadDetail.setTXN_CODE("K10");//Code transaction TXN_CODE
                    detbUploadDetail.setAMOUNT(new BigDecimal(Utility.bourrageGauche(Utility.getParamOfType("COMDEBREJSIGNCHQRET" + pers + "FLEX", "CODE_COMMISSION").trim(), 16, " ").trim())); //AMOUNT
                    detbUploadDetail.setADDL_TEXT(dateValeur + Utility.bourrageGauche(cheque.getNumerocheque(), 8, " ") + Utility.bourrageGZero(cheque.getIdcheque().toPlainString(), 8) + " " + Utility.bourrageDroite(Utility.getParam("LIBREJCHQRETFLEX1"), 18, " ") + "030" + cheque.getMotifrejet());
                    detbUploadDetail.setREL_CUST(compteFlexCube != null ? compteFlexCube.getNumcptex().substring(0, 9) : "");
                    detbUploadDetail.setEXTERNAL_REF_NO(cheque.getIdcheque() + detbUploadDetail.getBATCH_NO());
                    detbUploadDetail.setRELATED_ACCOUNT(compteFlexCube != null ? compteFlexCube.getNumcptex() : "");
                    ...
                    line.append(createBlancs(4, " "));
                    line.append("C");
                    line.append(Utility.bourrageGauche(Utility.getParamOfType("COMCREREJSIGNCHQRET" + pers + "FLEX1", "CODE_COMMISSION"), 16, " "));
                    line.append("F57");
                    line.append(dateValeur);
                    line.append(createBlancs(8, " "));
                    line.append(Utility.bourrageDroite(Utility.getParam("LIBREJCHQRETFLEX2"), 25, " "));
                    ...
                    detbUploadDetail.setDR_CR("C");//DR_CR Sens D ou C
                    detbUploadDetail.setTXN_CODE("K10");//Code transaction TXN_CODE
                    detbUploadDetail.setAMOUNT(new BigDecimal(Utility.bourrageGauche(Utility.getParamOfType("COMCREREJSIGNCHQRET" + pers + "FLEX1", "CODE_COMMISSION").trim(), 16, " ").trim())); //AMOUNT
                    detbUploadDetail.setADDL_TEXT(dateValeur + Utility.bourrageDroite(Utility.getParam("LIBREJCHQALEFLEX4"), 25, " "));
                    detbUploadDetail.setREL_CUST((Utility.getParam("CPTCRECOMREJCHQRET1").length() == 16) ? Utility.getParam("CPTCRECOMREJCHQRET1").substring(6, 14) : "999999992");
                    detbUploadDetail.setEXTERNAL_REF_NO(detbUploadDetail.getBATCH_NO());
                    detbUploadDetail.setRELATED_ACCOUNT(Utility.getParam("CPTCRECOMREJCHQRET1"));
                    detbUploadDetail.setTXT_FILE_NAME(new File(fileName).getName());
                    detbUploadDetails.add(detbUploadDetail);
                    ...
                    line.append(createBlancs(4, " "));
                    line.append("C");
                    line.append(Utility.bourrageGauche(Utility.getParamOfType("COMCREREJSIGNCHQRET" + pers + "FLEX2", "CODE_COMMISSION"), 16, " "));
                    line.append("F57");
                    line.append(dateValeur);
                    line.append(createBlancs(8, " "));
                    line.append(Utility.bourrageDroite(Utility.getParam("LIBREJCHQRETFLEX3"), 25, " "));
                    ...
                    detbUploadDetail.setDR_CR("C");//DR_CR Sens D ou C
                    detbUploadDetail.setTXN_CODE("K10");//Code transaction TXN_CODE
                    detbUploadDetail.setAMOUNT(new BigDecimal(Utility.bourrageGauche(Utility.getParamOfType("COMCREREJSIGNCHQRET" + pers + "FLEX2", "CODE_COMMISSION").trim(), 16, " ").trim())); //AMOUNT
                    detbUploadDetail.setADDL_TEXT(dateValeur + Utility.bourrageDroite(Utility.getParam("LIBREJCHQRETFLEX3"), 25, " "));
                    detbUploadDetail.setREL_CUST((Utility.getParam("CPTCRECOMREJCHQRET2").length() == 16) ? Utility.getParam("CPTCRECOMREJCHQRET2").substring(6, 14) : "999999992");
                    detbUploadDetail.setEXTERNAL_REF_NO(detbUploadDetail.getBATCH_NO());
                    detbUploadDetail.setRELATED_ACCOUNT(Utility.getParam("CPTCRECOMREJCHQRET2"));
                    detbUploadDetail.setTXT_FILE_NAME(new File(fileName).getName());
                    detbUploadDetails.add(detbUploadDetail);
                }
...
// Gestion cpt globalisation
            ...
            detbUploadDetail.setREL_CUST((Utility.getParam("CPTDEBREJCHQRET").length() == 16) ? Utility.getParam("CPTDEBREJCHQRET").substring(6, 14) : "999999992");
            detbUploadDetail.setEXTERNAL_REF_NO(detbUploadDetail.getBATCH_NO());
