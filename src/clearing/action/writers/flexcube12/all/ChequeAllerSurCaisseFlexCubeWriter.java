 ...
 * @author Patrick
 */
public class ChequeAllerSurCaisseFlexCubeWriter extends FlatFileWriter {

    public ChequeAllerSurCaisseFlexCubeWriter() {
...
// Population
        ...
        if (cheques != null && 0 < cheques.length) {
            StringBuffer line = new StringBuffer("H");
...
//Creation ligne de chèque
            ...
            fileName = Utility.getParam("SIB_IN_FOLDER") + File.separator + Utility.getParam("CHQCAISSE_IN_FILE_ROOTNAME1") + dateTraitement + Utility.getParam("SIB_FILE_SQL_EXTENSION");

            setOut(createFlatFile(fileName));
            line = new StringBuffer("HP");
