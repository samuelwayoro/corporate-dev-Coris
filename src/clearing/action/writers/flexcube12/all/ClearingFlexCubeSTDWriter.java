 ...
 */
public class ClearingFlexCubeSTDWriter extends FlatFileWriter {


    private ChequeAllerFlexCubeSTDWriter cafcw;
    ...
    public ClearingFlexCubeSTDWriter() {
        setDescription("Generation des fichiers vers le SIB");

       
        cafcw = new ChequeAllerFlexCubeSTDWriter();
