 ...
 * @author Patrick
 */
public class ChequeAllerNonCompFlexCubeEBEWriter extends FlatFileWriter {

    public ChequeAllerNonCompFlexCubeEBEWriter() {
...
//Creation ligne de chèque
                        ...
                        for (int x = 0; x < chequesVal.length; x++) {
                            ...
                            detbUploadDetail.setTXN_CODE("Q13");//Code transaction TXN_CODE
                            detbUploadDetail.setAMOUNT(new BigDecimal(aCheque.getMontantcheque())); //AMOUNT
                            detbUploadDetail.setVALUE_DATE(Utility.convertStringToDate(dateValeurDebit, "yyyyMMdd"));
