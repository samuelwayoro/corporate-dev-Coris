 ...
 * @author Patrick
 */
public class ChequeAllerRejeteFlexCubeWriter extends FlatFileWriter {

    public ChequeAllerRejeteFlexCubeWriter() {
        ...
        if (cheques != null && 0 < cheques.length) {
            ...
            for (int i = 0; i < cheques.length; i++) {
                ...
                if (cheque.getMotifrejet().equalsIgnoreCase("201") || cheque.getMotifrejet().equalsIgnoreCase("202")) {
                    ...
                    detbUploadDetail.setTXN_CODE("Q11");//Code transaction TXN_CODE
                    detbUploadDetail.setAMOUNT(new BigDecimal(Utility.bourrageGauche(Utility.getParamOfType("COMCREREJCHQALE" + pers + "FLEX1", "CODE_COMMISSION").trim(), 16, " "))); //AMOUNT
