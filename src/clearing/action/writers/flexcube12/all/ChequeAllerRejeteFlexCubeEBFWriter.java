 ...
 * @author Patrick
 */
public class ChequeAllerRejeteFlexCubeEBFWriter extends FlatFileWriter {

    public ChequeAllerRejeteFlexCubeEBFWriter() {
...
//                line.append(Utility.bourrageDroite(Utility.getParam("LIBREJCHQALEFLEX1"), 25, " "));
                line.append(Utility.bourrageDroite(Utility.getParam("LIBREJCHQALEFLEX1") + cheque.getNumerocheque() + " " + cheque.getMotifrejet() + " " + Utility.getParamLabel(cheque.getMotifrejet()).trim(), 100, " "));
//                line.append("030");
//                line.append(Utility.bourrageGZero(cheque.getIdcheque().toPlainString(), 8));
                ...
                detbUploadDetail.setADDL_TEXT(Utility.bourrageDroite(Utility.getParam("LIBREJCHQALEFLEX1") + cheque.getNumerocheque() + " " + cheque.getMotifrejet() + " " + Utility.getParamLabel(cheque.getMotifrejet()).trim(), 100, " "));
                ...
                if (cheque.getMotifrejet().equalsIgnoreCase("201") || cheque.getMotifrejet().equalsIgnoreCase("202")) {
                    ...
                    detbUploadDetail.setDR_CR("D");//DR_CR Sens D ou C
                    detbUploadDetail.setTXN_CODE("Q11");//Code transaction TXN_CODE
                    detbUploadDetail.setAMOUNT(new BigDecimal(Utility.bourrageGauche(Utility.getParamOfType("COMDEBREJCHQALE" + pers + "FLEX", "CODE_COMMISSION").trim(), 16, " ").trim())); //AMOUNT Utility.bourrageGauche(Utility.getParamOfType("COMDEBREJCHQALE" + pers + "FLEX", "CODE_COMMISSION"), 16, " ")
                    detbUploadDetail.setVALUE_DATE(CMPUtility.getDate() != null ? Utility.convertStringToDate(CMPUtility.getDate(), "yyyyMMdd") : new Date());
                    detbUploadDetail.setADDL_TEXT(CMPUtility.getDate() + Utility.bourrageGauche(cheque.getNumerocheque(), 8, " "));
                    detbUploadDetail.setREL_CUST((Utility.getParam("CPTCRECOMREJCHQALE1").length() == 16) ? Utility.getParam("CPTCRECOMREJCHQALE1").substring(6, 14) : "999999992");
                    detbUploadDetail.setEXTERNAL_REF_NO(cheque.getIdcheque() + detbUploadDetail.getBATCH_NO());
                    detbUploadDetail.setRELATED_ACCOUNT(Utility.getParam("CPTCRECOMREJCHQALE1"));
                    detbUploadDetail.setTXT_FILE_NAME(new File(fileName).getName());
                    detbUploadDetails.add(detbUploadDetail);
                ...
                if (cheque.getMotifrejet().equalsIgnoreCase("205") || cheque.getMotifrejet().equalsIgnoreCase("206")) {
                    ...
                    detbUploadDetail.setDR_CR("D");//DR_CR Sens D ou C
                    detbUploadDetail.setTXN_CODE("Q11");//Code transaction TXN_CODE
                    detbUploadDetail.setAMOUNT(new BigDecimal(Utility.bourrageGauche(Utility.getParamOfType("COMDEBREJSIGNCHQALE" + pers + "FLEX", "CODE_COMMISSION").trim(), 16, " ").trim())); //AMOUNT Utility.bourrageGauche(Utility.getParamOfType("COMDEBREJCHQALE" + pers + "FLEX", "CODE_COMMISSION"), 16, " ")
                    detbUploadDetail.setADDL_TEXT(CMPUtility.getDate() + Utility.bourrageGauche(cheque.getNumerocheque(), 8, " ") + Utility.bourrageDroite(Utility.getParam("LIBREJCHQALEFLEX1") + cheque.getNumerocheque() + " " + cheque.getMotifrejet() + " " + Utility.getParamLabel(cheque.getMotifrejet()).trim(), 100, " ") + cheque.getMotifrejet());
                    detbUploadDetail.setREL_CUST((Utility.getParam("CPTCRECOMREJCHQALE1").length() == 16) ? Utility.getParam("CPTCRECOMREJCHQALE1").substring(6, 14) : "999999992");
                    detbUploadDetail.setEXTERNAL_REF_NO(cheque.getIdcheque() + detbUploadDetail.getBATCH_NO());
                    detbUploadDetail.setRELATED_ACCOUNT(Utility.getParam("CPTCRECOMREJCHQALE1"));
                    detbUploadDetail.setTXT_FILE_NAME(new File(fileName).getName());
            ...
            line.append(dateValeur);
            line.append(createBlancs(8, " "));
            line.append(Utility.bourrageDroite(Utility.getParam("LIBREJCHQALEFLEX5").trim() + " " + Utility.convertDateToString(Utility.convertStringToDate(CMPUtility.getDate(), "yyyymmdd"), "dd/mm/yyyy"), 25, " "));
            line.append(createBlancs(14, " "));
            /**
             * ligne F12
             */
            ...
            detbUploadDetail.setADDL_TEXT(dateValeur + Utility.bourrageDroite(Utility.getParam("LIBREJCHQALEFLEX5").trim() + " " + Utility.convertDateToString(Utility.convertStringToDate(CMPUtility.getDate(), "yyyymmdd"), "dd/mm/yyyy"), 25, " "));
