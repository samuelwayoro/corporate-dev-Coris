                            ...
                            if (!isValidLine(cheques[i])) {
                                ...
                                if (cptGR.getSignature2() == null || (cptGR.getSignature2() != null && cptGR.getSignature2().trim().equals("R"))) {
                                    ...
                                    numLigne = createLinesSQL(current_cycle, current_period, numeroBatch, numLigne, "~", numeroBatch + "" + aCheque.getRemise(), "" + sumRemise,
                                            dateValeur, aCheque, libelle, new File(fileName).getName());
                                    ...
                                    for (int x = 0; x < chequesVal.length; x++) {
                                        ...
                                        numLigne = createLinesSQL(current_cycle, current_period, numeroBatch, numLigne, "~", numeroBatch + "" + aCheque.getIdcheque(),
                                                aCheque.getMontantcheque(), dateValeur, aCheque, libelle, new File(fileName).getName());
            ...
            for (int i = 0; i < cheques.length; i++) {
                ...
                if (!isValidLine(cheque)) {
                    ...
                    numLigne = createLinesRjtSQL(current_cycle, current_period, numeroBatch, numLigne, "~", numeroBatch + "" + cheque.getIdcheque(),
                            cheque.getMontantcheque(), Utility.convertDateToString(new java.util.Date(System.currentTimeMillis()), "ddMMyyyy"), cheque, "Rejet Cheque", new File(fileName).getName());
...
//                createLinesRejetFlex(cheque);
                int createLinesRejetSQL = createLinesRjtSQL(current_cycle, current_period, numeroBatch, i + 1, "~", numeroBatch + "" + cheque.getIdcheque(),
                        cheque.getMontantcheque(), Utility.convertDateToString(new Date(), "ddMMyyyy"), cheque, "Rejet Cheque", new File(fileName).getName());
...
//Creation ligne de chèque
    ...
    private void createEnteteSQL() {
        ...
        line.append("LOAD DATA\n"
                ...
                + " CURR_NO,AMOUNT,DR_CR,UPLOAD_STAT,CCY_CD,INITIATION_DATE,LCY_EQUIVALENT,EXCH_RATE,rel_cust,external_ref_no,related_account,TXT_FILE_NAME)\n"
                + "BEGINDATA");
    ...
    private int createLinesRjtSQL(String current_cycle, String current_period, String numeroBatch, int numLigne, String separateur, String referenceRelative,
            String montantLigne, String dateValeur, Cheques aCheque, String libelle, String fileName) throws Exception {
        //   + " (FIN_CYCLE,PERIOD_CODE,VALUE_DATE,ADDL_TEXT,BRANCH_CODE,SOURCE_CODE,ACCOUNT_BRANCH,ACCOUNT,TXN_CODE,BATCH_NO, "
...
//        String numCptExDO = CMPUtility.getNumCptEx(aCheque.getNumerocompte(), aCheque.getAgence());
//        if (numCptExDO == null) {
//            numCptExDO = aCheque.getAgence().substring(2) + "0" + aCheque.getNumerocompte();
//        }
        Comptes compteFlexCubeBenef = CMPUtility.getCompteESNFlexCube(aCheque.getCompteremettant(), aCheque.getAgenceremettant());
//        String numCptExBenef = CMPUtility.getNumCptEx(aCheque.getCompteremettant(), aCheque.getAgenceremettant());
...
//        }
        ...
        if (!aCheque.getEtat().equals(new BigDecimal(Utility.getParam("CETAOPEANO")))) {
            ...
            line.append(separateur);
            line.append(compteFlexCubeBenef != null ? compteFlexCubeBenef.getAdresse2().trim() : "" + Utility.getParam("TXN_BRANCH").charAt(0) + aCheque.getAgenceremettant().substring(3));  //agence du compte //!= null ? compteFlexCube.getAdresse2().trim() : aCheque.getAgence().substring(2)
            line.append(separateur);
            line.append(compteFlexCubeBenef != null ? compteFlexCubeBenef.getNumcptex().trim() : aCheque.getCompteremettant());
            line.append(separateur);
            line.append("K10");
            line.append(separateur);
            ...
            line.append(separateur);
            line.append(compteFlexCubeDO != null ? compteFlexCubeDO.getNumcptex().substring(0, 9) : ""); //rel_cust // usually ==> line.append(numCptEx != null ? numCptEx.substring(6, 14) : ""); //rel_cust '0017201000019901' 
            line.append(separateur);
            line.append(referenceRelative); //external_ref_no
            line.append(separateur);
            line.append(compteFlexCubeDO != null ? compteFlexCubeDO.getNumcptex() : aCheque.getNumerocompte()); //  // related_account
            line.append(separateur);
            ...
            line.append(Utility.getParam("BATCH_TYPE"));
            line.append(separateur);
            line.append(compteFlexCubeDO != null ? compteFlexCubeDO.getAdresse2().trim() : "" + Utility.getParam("TXN_BRANCH").charAt(0) + aCheque.getAgence().substring(3));  //agence du compte
            line.append(separateur);
            line.append(compteFlexCubeDO != null ? compteFlexCubeDO.getNumcptex().trim() : aCheque.getNumerocompte());
            line.append(separateur);
            line.append("F57");
            line.append(separateur);
            line.append(numeroBatch);
            ...
            line.append("1"); //EXCH_RATE
            line.append(separateur);
            line.append((compteFlexCubeBenef != null) ? compteFlexCubeBenef.getNumcptex().substring(0, 9) : "999999992"); //rel_cust // usually ==> line.append(numCptEx != null ? numCptEx.substring(6, 14) : ""); //rel_cust '0017201000019901' 
            //      line.append(numCptExDO != null ? numCptExDO.substring(6, 14) : ""); //rel_cust
            line.append(separateur);
            line.append(referenceRelative); //external_ref_no
            line.append(separateur);
            line.append((compteFlexCubeBenef != null) ? compteFlexCubeBenef.getNumcptex() : aCheque.getCompteremettant()); //  // related_account
            line.append(separateur);
            line.append(fileName);
            writeln(line.toString());
//(Utility.getParam("CPTATTCHQCAIFLEX").length() == 16) ? Utility.getParam("CPTATTCHQCAIFLEX").substring(6, 14) : "999999992"
            /**
             * //Prise de commission
             */
            ...
            line.append("1"); //EXCH_RATE
            line.append(separateur);
            line.append(compteFlexCubeDO != null ? compteFlexCubeDO.getNumcptex().substring(0, 9) : ""); //rel_cust
            line.append(separateur);
            line.append(referenceRelative); //external_ref_no
            line.append(separateur);
            line.append(compteFlexCubeDO != null ? compteFlexCubeDO.getNumcptex() : aCheque.getNumerocompte()); // 
            line.append(separateur);
            line.append(fileName);
            writeln(line.toString());
            ...
            line.append(Utility.getParam("BATCH_TYPE"));
            line.append(separateur);
            line.append(compteFlexCubeBenef != null ? compteFlexCubeBenef.getAdresse2().trim() : "" + Utility.getParam("TXN_BRANCH").charAt(0) + aCheque.getAgenceremettant().substring(3)); //agence du compte
            line.append(separateur);
            line.append(compteFlexCubeBenef != null ? compteFlexCubeBenef.getNumcptex().trim() : aCheque.getCompteremettant()); //Compte Client ou attente
            line.append(separateur);
            line.append("K10");
            line.append(separateur);
            line.append(numeroBatch);
            ...
            line.append(separateur);
            line.append((Utility.getParam("CPTCRECOMREJCHQRET1").length() == 16) ? Utility.getParam("CPTCRECOMREJCHQRET1").substring(6, 14) : "999999992"); //rel_cust
            //(Utility.getParam("CPTCRECOMREJCHQRET1").length() == 16) ? Utility.getParam("CPTCRECOMREJCHQRET1").substring(6, 14) : "999999992"
            line.append(separateur);
            line.append(referenceRelative); //external_ref_no
            line.append(separateur);
            line.append(Utility.getParam("CPTCRECOMREJCHQRET1"));// // related_account
            ...
            line.append("1"); //EXCH_RATE
            line.append(separateur);
            line.append(compteFlexCubeBenef != null ? compteFlexCubeBenef.getNumcptex().substring(0, 9) : ""); //rel_cust
            line.append(separateur);
            line.append(referenceRelative); //external_ref_no
            line.append(separateur);
            line.append(compteFlexCubeBenef != null ? compteFlexCubeBenef.getNumcptex() : aCheque.getCompteremettant());// // related_account
            ...
            line.append(Utility.getParam("BATCH_TYPE"));
            line.append(separateur);
            line.append(compteFlexCubeBenef != null ? compteFlexCubeBenef.getAdresse2() : aCheque.getAgenceremettant().substring(2));  //agence du compte
            line.append(separateur);
            line.append(compteFlexCubeBenef != null ? compteFlexCubeBenef.getNumcptex().trim() : aCheque.getCompteremettant());
            line.append(separateur);
            line.append("Q17");
            ...
            line.append("1"); //EXCH_RATE
            line.append(separateur);
            //      line.append((Utility.getParam("CPTATTCHQCAIFLEX").length() == 16) ? Utility.getParam("CPTATTCHQCAIFLEX").substring(6, 14) : "999999992"); //rel_cust // usually ==> line.append(numCptEx != null ? numCptEx.substring(6, 14) : ""); //rel_cust '0017201000019901' 
            line.append((Utility.getParam("CPTATTCHQCAIFLEX").length() == 16) ? Utility.getParam("CPTATTCHQCAIFLEX").substring(6, 14) : "999999992"); //rel_cust
            line.append(separateur);
            line.append(referenceRelative); //external_ref_no
            line.append(separateur);
    ...
    private int createLinesSQL(String current_cycle, String current_period, String numeroBatch, int numLigne, String separateur, String referenceRelative,
        ...
        //    String numCptEx = CMPUtility.getNumCptEx(aCheque.getCompteremettant(), aCheque.getAgenceremettant());
...
//        }
        ...
        line.append(Utility.getParam("BATCH_TYPE"));
        line.append(separateur);
        line.append(compteFlexCube != null ? compteFlexCube.getAdresse2() : aCheque.getAgenceremettant().substring(2));  //agence du compte
        line.append(separateur);
        line.append(compteFlexCube != null ? compteFlexCube.getNumcptex() : aCheque.getCompteremettant());
        line.append(separateur);
        line.append("F57");
