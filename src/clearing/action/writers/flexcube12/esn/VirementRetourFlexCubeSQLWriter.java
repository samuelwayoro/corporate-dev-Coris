...
//                String numCptEx = CMPUtility.getNumCptEx(virement.getNumerocompte_Beneficiaire(), virement.getAgence());
                ...
                line.append("~");
                line.append(Utility.convertDateToString(Utility.convertStringToDate(virement.getDatetraitement(), "yyyy/MM/dd"), Utility.getParam("DATE_FORMAT"))); //VALUE_DATE a recuperer par une requete
                line.append("~");
                ...
                line.append("~");
                line.append(compteFlexCube != null ? compteFlexCube.getAdresse2().trim() : "" + Utility.getParam("TXN_BRANCH").charAt(0) +  virement.getAgence().substring(3)); //Agence du compte
                line.append("~");
                ...
                if (compteFlexCube == null || compteFlexCube.getNumcptex().isEmpty()) {
                    ...
                    line.append(Utility.bourrageDroite(compteFlexCube.getNumcptex(), 12, " "));
                }
                ...
                line.append("~");
                line.append(compteFlexCube != null ? compteFlexCube.getNumcptex() : "" + virement.getNumerocompte_Beneficiaire()); //related account
                line.append("~");
                line.append(new File(fileName).getName());
                line.append("~");
                if (compteFlexCube != null && !compteFlexCube.getNumcptex().isEmpty()) {
                    writeln(line.toString());
                }
...
// Gestion cpt globalisation
            ...
            line.append(current_period); //PERIOD_CODE a recuperer par une requete
            line.append("~");
            line.append(Utility.convertDateToString(Utility.convertStringToDate(virements[0].getDatetraitement(), "yyyy/MM/dd"), Utility.getParam("DATE_FORMAT"))); //VALUE_DATE a recuperer par une requete
            line.append("~");
