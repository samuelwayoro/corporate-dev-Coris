...
public class ChequeAllerFlexCubeSQLWriter extends FlatFileWriter {
    ...
    public void execute() throws Exception {
        ...
        dateValeurJ2 = Utility.convertDateToString(Utility.convertStringToDate(dateValeurJ2, "yyyyMMdd"), Utility.getParam("DATE_FORMAT"));
        ...
        createEnteteSQL();
        /**
         * line.append(separateur); line.append(fileName);
         */
            ...
            for (int i = 0; i < cheques.length; i++) {
                ...
                if (!isValidLine(cheque)) {
                    ...
                    numLigne = createLinesRejetSQL(current_cycle, current_period, numeroBatch, numLigne, "~", numeroBatch + "" + cheque.getIdcheque(),
                            cheque.getMontantcheque(), Utility.convertDateToString(new java.util.Date(System.currentTimeMillis()), "ddMMyyyy"), cheque, "", new File(fileName).getName());
                            ...
                            if (!isValidLine(cheques[i])) {
                                ...
                                if (cptGR.getSignature2() == null || (cptGR.getSignature2() != null && cptGR.getSignature2().trim().equals("R"))) {
                                    ...
                                    numLigne = createLinesCRISQL(current_cycle, current_period, numeroBatch, numLigne, "~", numeroBatch + "" + aCheque.getRemise(), "" + sumRemise,
                                            dateValeur, libelle, new File(fileName).getName());
...
//                                   
                                        numLigne = createLinesCRISQL(current_cycle, current_period, numeroBatch, numLigne, "~", numeroBatch + "" + aCheque.getIdcheque(),
                                                aCheque.getMontantcheque(), dateValeur, libelle, new File(fileName).getName());
                    ...
                    if (remises != null && remises.length > 0) {
                        ...
                        if (chequesVal != null && 0 < chequesVal.length) {
                            ...
                            if (!isValidLine(cheques[i])) {
                                ...
                                String dateValeur;
                                Comptes cptGR = CMPUtility.getInfoCompte(aCheque.getCompteremettant());
                                if (cptGR.getSignature2() == null || (cptGR.getSignature2().isEmpty())|| (cptGR.getSignature2() != null && cptGR.getSignature2().trim().equals("R"))) {
                                ...
                                } else if ((cptGR.getSignature2() != null &&!cptGR.getSignature2().isEmpty() && cptGR.getSignature2().trim().equals("C"))) {
...
//                createLinesRejetFlex(cheque);
                createLinesRejetSQL(current_cycle, current_period, numeroBatch, i + 1, ";", numeroBatch + "" + cheque.getIdcheque(),
                        cheque.getMontantcheque(), Utility.convertDateToString(new Date(), "ddMMyyyy"), cheque, "", new File(fileName).getName());
                if (cheque.getEtat().toPlainString().equals(Utility.getParam("CETAOPEREJRET"))) {
                    cheque.setEtat(new BigDecimal(Utility.getParam("CETAOPEREJRETENVSIB")));
                    db.updateRowByObjectByQuery(cheque, "CHEQUES", "IDCHEQUE=" + cheque.getIdcheque());
                }
...
//        }
        /**
         * Format SQL LOADER line.append("LOAD DATA\n" + "INFILE *\n" +
        ...
        line.append(separateur);
        line.append(compteFlexCube != null ? compteFlexCube.getAdresse2().trim() : aCheque.getAgenceremettant().substring(2));//compteFlexCube != null ? compteFlexCube.getAdresse2().trim() : cheque.getAgence().substring(2)
        line.append(separateur);
        ...
        line.append(separateur);
        line.append((Utility.getParam("CPTGLOCOMREJCHQALE").length() == 16) ? Utility.getParam("CPTGLOCOMREJCHQALE").substring(6, 14) : "999999992"); //rel_cust
        //line.append((Utility.getParam("CPTCOMCHQALEFLEX").length() == 16) ? Utility.getParam("CPTCOMCHQALEFLEX").substring(6, 14) : "999999992"); //rel_cust
        line.append(separateur);
        ...
        if (aCheque.getMotifrejet().equalsIgnoreCase("201") || aCheque.getMotifrejet().equalsIgnoreCase("202")) {
            ...
            line.append(separateur);
            line.append(compteFlexCube != null ? compteFlexCube.getNumcptex().trim() : aCheque.getCompteremettant()); //Compte Client ou attente
            line.append(separateur);
            line.append("K10");
            line.append(separateur);
            line.append(numeroBatch);
            ...
            line.append(referenceRelative); //external_ref_no
            line.append(separateur);
            line.append(Utility.getParam("CPTGLOCOMREJCHQALE"));//  //(Utility.getParam("CPTGLOCOMREJCHQALE").length() == 16) ? Utility.getParam("CPTGLOCOMREJCHQALE").substring(6, 14) : "999999992"
            line.append(separateur);
            line.append(fileName);
            writeln(line.toString());
...
//        String numCptEx = CMPUtility.getNumCptEx(aCheque.getCompteremettant(), aCheque.getAgenceremettant());
        ...
        line.append("1"); //EXCH_RATE
        line.append(separateur);
        line.append((Utility.getParam("CPTATTCHQALEFLEX").length() == 16) ? Utility.getParam("CPTATTCHQALEFLEX").substring(6, 14) : "999999992"); //rel_cust
        //  line.append((Utility.getParam("CPTCOMCHQALEFLEX").length() == 16) ? Utility.getParam("CPTCOMCHQALEFLEX").substring(6, 14) : "999999992"); //rel_cust
        line.append(separateur);
        line.append(referenceRelative); //external_ref_no
        line.append(separateur);
