 ...
 * @author Patrick
 */
public class ChequeAllerCBBFinWriter extends FlatFileWriter {

    public ChequeAllerCBBFinWriter() {
                   ...
                   (allChequesVal.length == remises[0].getNbOperation().intValue())){
                    ...
                    for (int x = 0; x < chequesVal.length; x++) {
                        ...
                        line =  Utility.bourrageGauche(aCheque.getCompteremettant(), 12, "0")+
                                ...
                                Utility.bourrageDroite(aCheque.getNombeneficiaire()+"|"+remises[0].getReference(),30, " ")+
