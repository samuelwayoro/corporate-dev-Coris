 ...
 * @author Patrick
 */
public class VirementRetourFinWriter extends FlatFileWriter{

    public VirementRetourFinWriter() {
       ...
       public void execute() throws Exception {
        ...
        if (virements != null && 0 < virements.length) {
            ...
            for (int i = 0; i < virements.length; i ++) {
                ...
                String line = "";
                line += virement.getNumerocompte_Beneficiaire()+"|"+virement.getDevise()+"|6499|C|";
                line += Utility.bourrageGZero(virement.getMontantvirement(), 12)+"|";
                line += Utility.bourrageDroite(virement.getLibelle(), 30, " ")+"|";
                line += Utility.bourrageGZero(virement.getMontantvirement(), 12)+"|"+virement.getDevise()+"|";
