 ...
 * @author Patrick
 */
public class ChequeAllerNonCompFlexCubeECMWriter extends FlatFileWriter {

    public ChequeAllerNonCompFlexCubeECMWriter() {
...
//Creation ligne de chèque
                        ...
                        for (int x = 0; x < chequesVal.length; x++) {
                            ...
                            line.append(Utility.bourrageDroite(CMPUtility.getNumCptExEAC(aCheque.getCompteremettant(), aCheque.getAgenceremettant()), 16, " "));
...
//Creation ligne de chèque
                        ...
                        for (int x = 0; x < chequesVal.length; x++) {
                            ...
                            line = new StringBuffer();
                            line.append(aCheque.getAgence().substring(2));
                            line.append(Utility.bourrageDroite(CMPUtility.getNumCptExEAC(aCheque.getNumerocompte(),aCheque.getAgence()), 16, " "));
                            line.append(createBlancs(4, " "));
                            line.append("D");
                            line.append(Utility.bourrageGauche("" + aCheque.getMontantcheque(), 16, " "));
                            line.append("Q13");
