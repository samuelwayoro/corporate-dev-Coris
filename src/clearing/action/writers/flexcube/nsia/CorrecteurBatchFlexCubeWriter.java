...
public class CorrecteurBatchFlexCubeWriter extends FlatFileWriter {
    ...
    private void writeFile(DETB_UPLOAD_DETAIL[] detbUploadDetailList) {
        ...
        for (DETB_UPLOAD_DETAIL detbUploadDetail : detbUploadDetailList) {
            String line = sep(detbUploadDetail.getFIN_CYCLE())
                    ...
                    + sep(Utility.convertDateToString(detbUploadDetail.getVALUE_DATE(), Utility.getParam("DATE_FORMAT")))
                    ...
                    + sep(Utility.convertDateToString(detbUploadDetail.getINITIATION_DATE(), Utility.getParam("DATE_FORMAT")))
    ...
    private void createEnteteSQL() {
        ...
        line.append("LOAD DATA\n"
                ...
                + " CURR_NO,AMOUNT,DR_CR,UPLOAD_STAT,CCY_CD,INITIATION_DATE DATE \"" + Utility.getParam("DATE_FORMAT") + "\" ,LCY_EQUIVALENT,EXCH_RATE,rel_cust,external_ref_no,related_account)\n"
                + "BEGINDATA");
