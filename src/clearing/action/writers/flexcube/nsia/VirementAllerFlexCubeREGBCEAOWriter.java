 ...
 * @author Patrick
 */
public class VirementAllerFlexCubeREGBCEAOWriter extends FlatFileWriter {

    public VirementAllerFlexCubeREGBCEAOWriter() {
...
//            writeln(line.toString());
            for (int i = 0; i < virements.length; i++) {
                ...
                detbUploadDetail.setACCOUNT(Utility.getParam("CPTREGBCEAO"));//REM ACCOUNT
                ...
                detbUploadDetail.setADDL_TEXT(CMPUtility.getDate() + Utility.bourrageDroite(virement.getLibelle(), 100, " "));
                detbUploadDetail.setREL_CUST((Utility.getParam("CPTREGBCEAO").length() == 19) ? Utility.getParam("CPTREGBCEAO").substring(6, 14) : "999999996");
...
;
            ...
            detbUploadDetail.setADDL_TEXT(CMPUtility.getDate() + Utility.bourrageDroite(Utility.getParam("LIBVIRALEFLEX1"), 25, " "));
