 ...
 * @author Patrick
 */
public class CPTRETFlexCubeNSIAWriter extends FlatFileWriter {

    public CPTRETFlexCubeNSIAWriter() {
        setDescription("Envoi du fichier CPTRET vers le SIB");
    }
...
// Population
        sql = "SELECT * FROM CHEQUES WHERE "
                + "ETAT IN (" + Utility.getParam("CETAOPERETREC") + "," + Utility.getParam("CETAOPERET")+ "," +
                Utility.getParam("CETAOPERETENVSIB") + "," +Utility.getParam("CETAOPERETRECENVSIB") + ") "
