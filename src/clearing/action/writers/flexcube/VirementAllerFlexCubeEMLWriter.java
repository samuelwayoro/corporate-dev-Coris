 ...
 * @author Patrick
 */
public class VirementAllerFlexCubeEMLWriter extends FlatFileWriter {

    public VirementAllerFlexCubeEMLWriter() {
    ...
    public void execute() throws Exception {
        ...
        String sql = "SELECT * FROM VIREMENTS WHERE ETAT IN (" + Utility.getParam("CETAOPESTO") + ") ";
        ...
        if (virements != null && 0 < virements.length) {
            ...
            for (int i = 0; i < virements.length; i++) {
                ...
                String numCptex = "";
                    Comptes[] comptes = (Comptes[]) db.retrieveRowAsObject("select * from comptes where numero  ='" + virement.getNumerocompte_Tire() + "' and agence ='"+virement.getAgenceremettant()+"'", new Comptes());
                ...
                if (virement.getEtat().toPlainString().equals(Utility.getParam("CETAOPESTO"))) {
