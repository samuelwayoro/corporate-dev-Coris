 ...
 * @author Patrick
 */
public class VirementRetourFlexCubeEBFWriter extends FlatFileWriter {

    public VirementRetourFlexCubeEBFWriter() {
...
//                line.append(Utility.bourrageDroite(virement.getLibelle(), 18, " "));
                line.append(Utility.bourrageDroite(virement.getNom_Tire() + " " + virement.getLibelle(), 100, " "));
                // line.append(Utility.bourrageDroite(virement.getNom_Tire(), 18, " "));
...
// Gestion cpt globalisation
            ...
            closeFile();
            db.executeUpdate("UPDATE VIREMENTS SET ETAT =" + Utility.getParam("CETAOPERETENVSIB") + " WHERE ETAT=" + Utility.getParam("CETAOPERET"));
