...
////        }
        ...
        String fileName = Utility.getParam("SIB_IN_FOLDER") + File.separator + Utility.getParam("EFF_OUT_FILE_ROOTNAME") + Utility.convertDateToString(new Date(), "ddMMyyyy") + Utility.getParam("SIB_FILE_SQL_EXTENSION");
            ...
            for (int i = 0; i < effets.length; ++i) {
                ...
                if (!isValidLine(effet)) {
                    ...
                    numLigne = createLinesSQL(current_cycle, current_period, numeroBatch, numLigne, "~", numeroBatch + "" + effet.getIdeffet(),
                            "" + effet.getMontant_Effet(), Utility.convertDateToString(new Date(), "ddMMyyyy"), "D",
                            effet, libelleComptable, "F03");
...
//                    null, Utility.getParam("LIBEFFRETFLEX2"), "F03");
    ...
    private int createLinesSQL(String current_cycle, String current_period, String numeroBatch, int numLigne, String separateur, String referenceRelative,
        ...
        if (effet != null) {
            ...
            line.append(separateur);
            line.append(numCptEx != null ? numCptEx.substring(0, 3) : effet.getAgence().substring(2)); //Agence du compte
