...
public class EffetRetourRejeteFlexCubeSQLWriter extends FlatFileWriter {
    ...
    public void execute() throws Exception {
        ...
        String fileName = Utility.getParam("SIB_IN_FOLDER") + File.separator + Utility.getParam("EFF_REJ_RET_FILE_ROOTNAME") + Utility.convertDateToString(new Date(), "ddMMyyyy") + Utility.getParam("SIB_FILE_SQL_EXTENSION");
    ...
    private int createLinesSQL(String current_cycle, String current_period, String numeroBatch, int numLigne, String separateur, String referenceRelative,
        ...
        line.append("1"); //EXCH_RATE
        line.append(separateur);
        line.append((Utility.getParam("CPTCREEFFRET").length() == 16) ? Utility.getParam("CPTCREEFFRET").substring(6, 14) : "99999999"); //rel_cust /(Utility.getParam("CPTDEBREJCHQRET").length() == 16) ? Utility.getParam("CPTDEBREJCHQRET").substring(6, 14) : "99999999"
        line.append(separateur);
        line.append(referenceRelative); //external_ref_no
        line.append(separateur);
