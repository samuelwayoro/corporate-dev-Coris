    ...
    public void execute() throws Exception {
        ...
        if (virements != null && 0 < virements.length) {
            ...
            for (int i = 0; i < virements.length; i++) {
                ...
                //line.append((Utility.bourrageGZero(CMPUtility.getNumCptEx(virement.getNumerocompte_Beneficiaire(),virement.getAgence()), 16)).substring(0,3));
                line.append(virement.getAgence().substring(2));
...
// Gestion cpt globalisation
            ...
            line.append(Utility.bourrageDroite(Utility.getParam("CPTDEBVIRRET"), 9, " "));
