 ...
 * @author Patrick
 */
public class ChequeAllerSurCaisseFlexCubeSQLWriter1 extends FlatFileWriter {

    public ChequeAllerSurCaisseFlexCubeSQLWriter1() {
    ...
    public void execute() throws Exception {
        ...
        if (cheques != null && 0 < cheques.length) {
            ...
            setDescription("Envoi des rejets de chèques Non Compensables vers le SIB");
        ...
        // Population des Cheques à payer
                        ...
                        if (chequesVal != null && 0 < chequesVal.length) {
                            ...
                            if (!isValidLine(cheques[i])) {
                                ...
                                for (int x = 0; x < chequesVal.length; x++) {
                                    System.out.println("aCheque" + chequesVal[x].getIdcheque());
...
//                                    + "    AND REMISE=" + aCheque.getRemise());
            ...
            setDescription(getDescription() + "<br>Envoi des chèques Aller Sur Caisse vers le SIB");
