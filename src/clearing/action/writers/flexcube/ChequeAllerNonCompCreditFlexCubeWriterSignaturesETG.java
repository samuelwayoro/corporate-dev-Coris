 ...
 * @author Patrick
 */
public class ChequeAllerNonCompCreditFlexCubeWriterSignaturesETG extends FlatFileWriter {

    public ChequeAllerNonCompCreditFlexCubeWriterSignaturesETG() {
...
// Population
        String sql = "SELECT * FROM CHEQUES WHERE ETAT=" + Utility.getParam("CETAOPESUPVALSURCAI") + "AND LOTSIB=2 ORDER BY REMISE";
