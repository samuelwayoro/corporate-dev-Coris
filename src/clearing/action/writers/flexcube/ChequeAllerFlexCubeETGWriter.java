            ...
            for (int i = 0; i < cheques.length; i += j) {
                ...
                if (chequesVal != null && 0 < chequesVal.length) {
                    ...
                    for (int x = 0; x < chequesVal.length; x++) {
                        ...
                        line.append(Utility.bourrageDroite(CMPUtility.getNumCptEx(aCheque.getCompteremettant(), aCheque.getAgenceremettant(),"0"), 16, " ")); //Utility.bourrageDroite(Utility.getParam("CPTATTCHQALEFLEX"), 16, " ") 
