 ...
 * @author Patrick
 */
public class VirementAllerFlexCubeECMWriter extends FlatFileWriter {

    public VirementAllerFlexCubeECMWriter() {
            ...
            for (int i = 0; i < virementsTous.length; i += j) {
                ...
                if (virementsSameCompteTireFichier != null && virementsSameCompteTireFichier.length > 0) {
                    ...
                    for (String banque : hashBanque.keySet()) {
                        ...
                        line.append(createBlancs(7, " "));
                        line.append(virementsSameCompteTireFichier[0].getType_Virement());
