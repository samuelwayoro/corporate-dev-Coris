...
public class CPTANLFlexCubeWriter extends FlatFileWriter {
    ...
    public void execute() throws Exception {
        ...
        if (Utility.getParam("ECOBANK_STANDARD") != null && Utility.getParam("ECOBANK_STANDARD").equalsIgnoreCase("0")) {
            compteur = Utility.bourrageGauche(Utility.computeCompteur("CPTANL", "CPTANL"), 4, "0");
            ...
            compteur = "n" + Utility.bourrageGauche(Utility.computeCompteurAlphaNum("CPTANL", "CPTANL"), 3, "0");
            isEcobankStandard = false;
        } else {
            compteur = Utility.bourrageGauche(Utility.computeCompteurAlphaNum("CPTANL", "CPTANL"), 4, "0");
...
// Population
        String sql = "SELECT * FROM CHEQUES WHERE ETAT IN (" + Utility.getParam("CETAOPEALLICOM1ACCENVSIB") + "," + Utility.getParam("CETAOPEREJRET") + "," + Utility.getParam("CETAOPEREJRETENVSIB") + ") AND DATECOMPENSATION='" + dateCompensation + "' ORDER BY REMISE";
