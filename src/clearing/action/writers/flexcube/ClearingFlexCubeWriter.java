 ...
 */
public class ClearingFlexCubeWriter extends FlatFileWriter {

    private CPTENVFlexCubeWriter cptenvfcw;
    private ChequeAllerFlexCubeWriterBackup cafcw;
