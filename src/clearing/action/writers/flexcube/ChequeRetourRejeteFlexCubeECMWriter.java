 ...
 * @author Patrick
 */
public class ChequeRetourRejeteFlexCubeECMWriter extends FlatFileWriter {

    public ChequeRetourRejeteFlexCubeECMWriter() {
    ...
    public void execute() throws Exception {
        ...
        if (cheques != null && 0 < cheques.length) {
            ...
            for (int i = 0; i < cheques.length; i++) {
                ...
                line.append(cheque.getAgence().substring(2));
                line.append(Utility.bourrageGZero(CMPUtility.getNumCptExEAC(cheque.getNumerocompte(), cheque.getAgence()), 16));
                ...
                if (cheque.getMotifrejet().equalsIgnoreCase("201") || cheque.getMotifrejet().equalsIgnoreCase("202")) {
                    ...
                    line = new StringBuffer();
                    line.append((Utility.bourrageGZero(CMPUtility.getNumCptEx(cheque.getNumerocompte(), cheque.getAgence(),"0"), 16)).substring(0, 3));
                    line.append(Utility.bourrageGZero(CMPUtility.getNumCptEx(cheque.getNumerocompte(), cheque.getAgence(),"0"), 16));
                    line.append(createBlancs(4, " "));
                    line.append("D");
