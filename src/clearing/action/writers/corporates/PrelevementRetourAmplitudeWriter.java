 ...
 * @author Patrick
 */
public class PrelevementRetourAmplitudeWriter extends FlatFileWriter {

    public PrelevementRetourAmplitudeWriter() {
...
// Population
        ...
        if (prelevements != null && 0 < prelevements.length) {
            ...
            strLine += "01001";
            strLine += Utility.bourrageGauche(Utility.getParam("COMCREPREL"), 11, "0");
            ...
            sumCompte = Long.parseLong(Utility.bourrageGauche(Utility.getParam("COMCREPREL"), 11, "0"));
            ...
            for (int x = 0; x < prelevements.length; x++) {
                ...
                line.append(Utility.bourrageGauche(prelevementsComp[x].getNumerocompte_Tire(), 11, "0"));
