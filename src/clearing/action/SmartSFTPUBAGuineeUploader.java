...
public class SmartSFTPUBAGuineeUploader extends FlatFileReader {

    FTPClient ftp = null;

    public SmartSFTPUBAGuineeUploader() {
    ...
    public void send(String fileName, String adresseIp, String cheminDistant) {
        try {
            ...
            Logger.getLogger(SmartSFTPUBAGuineeUploader.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
