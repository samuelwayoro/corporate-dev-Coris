...
public class SFTPUploader extends FlatFileReader {
    ...
    public  void send (String fileName, String adresseIp, String cheminDistant) {
        try {
            ...
            Logger.getLogger(SFTPUploader.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
  ...
  @Override
    public File treatFile(File aFile, Repertoires repertoire) {
        try {
            ...
            send(aFile.getAbsolutePath(),repertoire.getId(),repertoire.getPartenaire());
