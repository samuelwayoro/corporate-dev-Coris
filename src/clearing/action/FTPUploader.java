...
public class FTPUploader extends FlatFileReader {
  ...
  @Override
    public File treatFile(File aFile, Repertoires repertoire) {
        try {
            ...
            FTPUploader ftpUploader = new FTPUploader(repertoire.getId(), Utility.getParam("FTPUSER"), Utility.getParam("FTPPASSWORD"));
