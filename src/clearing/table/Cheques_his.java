...
public class Cheques_his  {
    private String etablissement;
    private BigDecimal idcheque = null;
    private BigDecimal idcheque_his = null;
    ...
    public Cheques_his(Cheques cheque) {
    ...
    public Cheques_his(BigDecimal idcheque) {
    ...
    public BigDecimal getIdcheque_his() {
        return idcheque_his;
    }

    public void setIdcheque_his(BigDecimal idcheque_his) {
        this.idcheque_his = idcheque_his;
    }
