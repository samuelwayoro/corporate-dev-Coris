...
public class Virements {
    ...
    private BigDecimal idvirement = null;
    ...
    public Virements(BigDecimal idvirement) {
    ...
    public String toString() {
        return "clearing.table.Virements[idvirement=" + getIdvirement() + "]";
    }

    public BigDecimal getIdvirement() {
        return idvirement;
    }

    public void setIdvirement(BigDecimal idvirement) {
        this.idvirement = idvirement;
    }
    ...
    public void setNumerovirement(String numerovirement) {
        this.numerovirement = Utility.bourrageGZero(numerovirement, 10);
    }
    ...
    public void setReference_Emetteur(String reference_Emetteur) {
        this.reference_Emetteur = Utility.bourrageDroite(reference_Emetteur, 10, " ");
    }
