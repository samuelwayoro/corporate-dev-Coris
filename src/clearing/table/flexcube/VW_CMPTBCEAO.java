 ...
 * @author Patrick
 */
public class VW_CMPTBCEAO implements Serializable {
    ...
    public VW_CMPTBCEAO(String numero) {
        this.numero = numero;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VW_CMPTBCEAO)) {
            return false;
        }
        VW_CMPTBCEAO other = (VW_CMPTBCEAO) object;
