...
public class Sibiccpt implements Serializable {
    ...
    public BigDecimal getLtremesc() {
        return ltremesc;
    }

    public void setLtremesc(BigDecimal ltremesc) {
    ...
    public String getGestnumtel() {
        return gestnumtel;
    }

    public void setGestnumtel(String gestnumtel) {
        this.gestnumtel = gestnumtel;
    }
