...
<html>
    ...
    if (message != null && message.getMessage() != null) {
        ...
        <div id="tableSaisieRemiseDIV" align="center">
            ...
            <jsp:useBean id="comboCompteBean" scope="session" class="clearing.web.bean.ComboCompteCNCEBean" />
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="numero" value="" maxlength="12" onKeypress="return numeriqueValide(event);" onblur=" chargeInfoCompteCNCE();" /></td>
                            <% } else {%>
                            <td><input type="text" name="numero" value="${requestScope['compteRemettant']}" maxlength="12" onKeypress="return numeriqueValide(event);" onblur=" chargeInfoCompteCNCE();" /></td>
                            <%}
     ;%>
                            <td></td>
                            <td></td>
     ...
     ;%>
                        ...
                        <tr>
                            <td>Agence: </td>
                            <td> <a:widget name="dojo.combobox" id="agenceCompte"
                                              value="" subscribe="/cl" publish="/choix/agenceCNCE"/> <!--<input type="text" name="agence" value=""  disabled/>--></td>
                            <td></td>
                            <td></td>
                            <td>Reference: </td>
                ...
                <input type="hidden" value="" name="agence" />
                <input type="hidden" name="sequenceObjet" value="${requestScope['sequenceObjet']}"/>
            </form>
...
<fieldset id="divField">
            ...
            ;%>
                            ...
                            <td></td>
                            <td>Remise: </td>
                            <td><input type="button" name="idremise" value="${requestScope['idremise']}" onclick="location.replace('saisieremises_cnce.jsp?action=remise&idremise=${requestScope["idremise"]}')"/></td>
            ...
            <br>
            <%if (index > 1) {%>
            <input type="button" value="Precedent" name="Précédent" onclick="window.location.replace('saisieremises_cnce.jsp?action=precedent&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
            <%}%>
            <%if (nbOpers > index) {%>
            <input type="button" value="Suivant" name="Suivant" onclick="window.location.replace('saisieremises_cnce.jsp?action=suivant&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
            <%}%>
            </fieldset>
        </div>
        <%}%>
