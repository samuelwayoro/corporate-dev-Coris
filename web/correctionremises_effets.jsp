...
<html>
            ...
            if (action != null && (action.equalsIgnoreCase("precedent") || action.equalsIgnoreCase("suivant"))) {
               ...
               // Cheques[] cheques = (Cheques[]) db.retrieveRowAsObject(sql, new Cheques());
                ...
                if (effets != null && effets.length > 0) {
                    ...
                    request.setAttribute("montantCheque", effets[0].getMontant_Effet());
                ...
                if (remises != null && remises.length > 0) {
                   ...
                   // request.setAttribute("typeEffet", remises[0].getTypeRemise());
                    ...
                    if (lastDocType.equalsIgnoreCase("REMISE")) {
                       ...
                       // sql = "SELECT * FROM CHEQUES WHERE IDCHEQUE=" + lastId + " AND ETAT =" + Utility.getParam("CETAOPEANO") + "  AND SEQUENCE=" + lastIdSeq;
                        ...
                        if (effets != null && effets.length > 0) {
                            ...
                            //type effets 
                             request.setAttribute("typeEffet", effets[0].getType_Effet());
    ...
    if (message != null && message.getMessage() != null) {
     ...
     ;%>
                            ...
                            <%  if ((request.getAttribute("typeEffet") != null) && (request.getAttribute("typeEffet").toString().contains("045"))) {%>
<!--                            <td><input type="text" name="typeEffet"   value="${requestScope['typeEffet']}" /></td>-->
                            
                             <td>
                                <SELECT name="typeEffet" id="typeEffet" size="1"  >
                                    <OPTION value="${requestScope['typeEffet']}" selected>045-Billet à ordre</OPTION>
<!--                                    <OPTION value="045">045-Billet à ordre  </OPTION>-->
                                    <OPTION value="046">046-Lettre de change</OPTION>
                                </SELECT>
                            </td>
                            
                                <% }else if ((request.getAttribute("typeEffet") != null) && (request.getAttribute("typeEffet").toString().contains("046"))) {%>
<!--                            <td><input type="text" name="typeEffet"   value="${requestScope['typeEffet']}" /></td>-->
                            <td>
                             <td>
                                <SELECT name="typeEffet" id="typeEffet" size="1"  >
                                    <OPTION value="${requestScope['typeEffet']}" selected>046-Lettre de change</OPTION>
                                    <OPTION value="045">045-Billet à ordre  </OPTION>
<!--                                    <OPTION value="046">046-Lettre de change</OPTION>-->
                                </SELECT>
                            </td>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" name="montantEffet" value="" onKeypress="return(currencyFormat(this,' ',event));" tabindex="1"/></td>
                            <% } else {%>
                            <td><input type="text" name="montantEffet" value="${requestScope['montantEffet']}" onKeypress="return numeriqueValide(event);" tabindex="1"/></td>
                            <%}
            ;%>
                            ...
                            <td></td>
                            <td>Remise: </td>
                            <td><input type="button" name="idremise" value="${requestScope['idremise']}" onclick="location.replace('correctionremises_effets.jsp?action=remise&idremise=${requestScope["idremise"]}')"/></td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="numeroEffet"  value="${requestScope['numeroEffet']}" maxlength="7" onKeypress="return numeriqueValide(event);" tabindex="6"/></td>
                            <td></td>
                            <td><input type="submit" name="valider" value="Valider" onclick="checkEffet();" tabindex="7"/></td>
                ...
                <input type="hidden" value="corrigeEffet" name="action" />
                <input type="hidden" value="${requestScope['index']}" name="index" />
            </form>
            <b>Cheque ${requestScope['index']} sur ${requestScope['nbOpers']}</b>
            <br>
            <%if (index > 1) {%>
            <input type="button" value="Precedent" name="Précédent" onclick="window.location.replace('correctionremises_effets.jsp?action=precedent&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
            <%}%>
            <%if (nbOpers > index) {%>
            <input type="button" value="Suivant" name="Suivant" onclick="window.location.replace('correctionremises_effets.jsp?action=suivant&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
            <%}%>
        </div>
        <%}%>
