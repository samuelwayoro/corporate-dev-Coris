...
<html>
    <head>
        ...
        <title>Rapports des Syntheses</title>
        <style type="text/css">
            body {
    ...
    <body>
        <h2>Rapports des Syntheses</h2>

        <div align="center">
            <form  id="paramrapport" name="paramrapport" method="POST" action="ControlServlet" onsubmit=" return (resolveSyntheses());">
                ...
                <table cellspacing="5" cellpadding="5">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Date Compensation J-1</td>
                            <td><a:widget name="dojo.dropdowndatepicker" id="dateCompensationPrec"/></td>
                            <td></td>
                        </tr>
                     <tr>
                ...
                <input type=hidden name="action" value="rapportSyntheses"/>
                <input type=hidden name="nomrapport" value="soldeCompense"/>
                <input type=hidden name="dateChoisie" value=""/>
                <input type=hidden name="datePrecChoisie" value=""/>
