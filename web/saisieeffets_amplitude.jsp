...
<html>
    ...
    <div id="tableSaisieRemiseDIV" align="center">
        <fieldset id="divField">
            ...
            <jsp:useBean id="comboCompteBean" scope="session" class="clearing.web.bean.ComboCompteBDKBean" />
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="numero" value="" maxlength="16" onKeypress="return numeriqueValide(event);" onblur=" chargeInfoCompteBDK();" /></td>
                                <% } else {%>
                            <td><input type="text" name="numero" value="${requestScope['compteRemettant']}" maxlength="16" onKeypress="return numeriqueValide(event);" onblur=" chargeInfoCompteBDK();" /></td>
                                <%}%>
                            <td></td>
                            <td></td>
...
<!--                                    <OPTION value="046">046-Lettre de change</OPTION>-->
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="reference" value="${requestScope['reference']}" maxlength="12" /></td>
                                <%}%>
                            <td></td>
                            <td><input type="submit" name="valider" value="Valider" onclick="checkRemiseViergeEffetsType();" /></td>

                        </tr>
                    </tbody>
                </table>

                <input type="hidden" value="checkRemiseViergeEffetsType" name="action" />
...
<!--                            <td><input type="checkbox" id="force" name="forcage" value="OFF" />Forcage Doublon</td>-->
            ...
            <br>
            <%if (index > 1) {%>
            <input type="button" value="Remise" name="Remise" onclick="window.location.replace('saisieeffets_amplitude.jsp?action=remise&ideffet=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
            <input type="button" value="Precedent" name="Précédent" onclick="window.location.replace('saisieeffets_amplitude.jsp?action=precedent&ideffet=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
            <%}%>
            <%if (nbOpers > index) {%>
            <input type="button" value="Suivant" name="Suivant" onclick="window.location.replace('saisieeffets_amplitude.jsp?action=suivant&ideffet=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
            <%}%>
        </fieldset>
    </div>
