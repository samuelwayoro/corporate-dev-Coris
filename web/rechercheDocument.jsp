...
<html>
    ...
    <body>
        ...
        String requeteDetail = request.getParameter("requeteDetail");
        String dropdown = request.getParameter("dropdown");
        if (requete != null) {
            request.setAttribute("filtre", URLEncoder.encode(requete, "UTF-8"));
        }
        if (requeteDetail != null) {
            request.setAttribute("filtre1", URLEncoder.encode(requeteDetail, "UTF-8"));
        }

        if (dropdown != null) {
            request.setAttribute("dropdown", URLEncoder.encode(dropdown, "UTF-8"));
        }
        ...
        <form  id="param" name="param">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Table : </td>
                        <td><a:widget name="dojo.combobox" id="tables"  value="[{label : '${param['objet']}', value : '${param['objet']}', selected : true} ]"  publish="/cl/getTables"/></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
        ...
        <form  id="paramUpdate" name="paramUpdate"  onsubmit=" return (areFieldsNotEmpty(this) && showSearchDocsResult('${param['vue']}','${requestScope['filtre']}','${param['objet']}','${param['nomidobjet']}','${requestScope['dropdown']}','${requestScope['filtre1']}','${param['cle']}'));">
