...
<!--                            <td><input type="checkbox" id="force" name="forcage" value="OFF" />Forcage Doublon</td>-->
            ...
            <br>
            <%if (index > 1) {%>
            <input type="button" value="Remise" name="Remise" onclick="window.location.replace('saisieeffets_type.jsp?action=remise&ideffet=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
