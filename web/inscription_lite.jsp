...
<html>
    ...
    <div align="center">
        <form  id="inscription" name="inscription" onsubmit="return (testPass(this) && addHiddenUser() && doAjaxSubmit(this,undefined,'ControlServlet'));">
            ...
            <input type=hidden name="action" value="inscription_lite"/>
