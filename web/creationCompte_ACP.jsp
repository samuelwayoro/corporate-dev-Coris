...
<html>
    ...
    <div align="center">
        <form  id="creationCompteClient" name="creationCompteClient" onsubmit="return ( doAjaxSubmit(this,undefined,'ControlServlet'));">
            <table border="0" cellspacing="2" cellpadding="2">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type=text name="numeroCompte" maxlength="10" onKeypress="return numeriqueValide(event);"/></td>
                    </tr>
                    <tr>
                        <td>Numéro de Compte Externe:</td>
                        <td><input type=text name="numCptEx" maxlength="16" /></td>
                    </tr>
                    <tr>
                        <td>Agence du Compte:</td>
                        <td><input type=text name="agenceCompte" maxlength="3" onKeypress="return numeriqueValide(event);"/></td>
            ...
            <input type=hidden name="action" value="creationCompteClientACP"/>
