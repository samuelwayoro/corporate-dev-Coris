...
<html>
    ...
    <body>
        ...
        <form  id="param" name="param">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Table : </td>
                        <td><a:widget name="dojo.combobox" id="tables"  value="[{label : 'REMISES', value : 'REMISES', selected : true} ]"  publish="/cl/getTables"/></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
        ...
        <form  id="paramUpdate" name="paramUpdate"  onsubmit=" return (areFieldsNotEmpty(this) && showSearchResult3());">
