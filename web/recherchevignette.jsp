...
<html>
    ...
    <body onload="return chargeTous()">
        ...
        %>
        <div align="center">
            <form  id="paramsearch" name="paramsearch"  onsubmit="return resolveVignette();">
                ...
                <table cellspacing="5" cellpadding="5">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="checkbox" name="num" value="ON" checked/>Numero Cheque</td>
                            <td><input type=text name="numero" /></td>
                            <td></td>
                            <td><input type="checkbox" name="code" value="ON" />Code Vignette</td>
                            <td><input type=text name="codeVignette" maxlength="12" /></td>
                            </tr>
