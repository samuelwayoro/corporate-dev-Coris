...
<body>
    ...
    DataBase db = new DataBase(JDBCXmlReader.getDriver());
        ...
        comboBanqueBean.setRequete("select * from banques where codebanque in (select distinct banqueremettant from cheques where etat in (" + Utility.getParam("CETAOPERETRECENVSIB") + ") AND DATECOMPENSATION >=( SELECT MAX(DATECOMPENSATION) FROM CHEQUES  WHERE ETAT=" + Utility.getParam("CETAOPERETRECENVSIB") + ") and lotsib in (1,2))");
    ...
    <div align="center">
        <form name='choixCodeBanques'>
            Choisissez une Banque : <a:widget name="dojo.combobox" id="banques" value="${comboBanqueBean.comboBanques}"/>
