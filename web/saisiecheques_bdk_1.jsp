                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="numero" value="" maxlength="12" onKeypress="return numeriqueValide(event);" onblur="chargeInfoCompteBDK();" /></td>
                            <% } else {%>
                            <td><input type="text" name="numero" value="${requestScope['compteRemettant']}" maxlength="12" onKeypress="return numeriqueValide(event);" onblur=" chargeInfoCompteBDK();" /></td>
                            <%}%>
                            <td></td>
                            <td></td>
                            <td>Montant: </td>
...
<fieldset id="divField">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" id="garde" name="garde" value="OFF" />Garde Ch&egrave;que</td>
                            <td> </td>
                            <td><input type="checkbox" id="calcul" name="calcul" value="OFF" />Int&eacute;grer à l&acute;assiette de Calcul</td>
                            <td></td>
                            <td>Date Ech&eacute;ance:</td>
            ...
            <br>
            <%if (index > 1) {%>
            <input type="button" value="Remise" name="Remise" onclick="window.location.replace('saisiecheques_bdk_1.jsp?action=remise&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
            <input type="button" value="Precedent" name="Précédent" onclick="window.location.replace('saisiecheques_bdk_1.jsp?action=precedent&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
            <%}%>
            <%if (nbOpers > index) {%>
            <input type="button" value="Suivant" name="Suivant" onclick="window.location.replace('saisiecheques_bdk_1.jsp?action=suivant&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
            <%}%>
            </fieldset>
        </div>
