...
<html>
    ...
    <body >
        ...
        %>
        <div align="center">
            <form name='choixFiltre' action="smartDataTable.jsp" method="POST" onsubmit=" return filterDataTable2();" accept-charset="utf8">
                <tr>
                ...
                <input type='hidden' name='param2' value='${param['paramDate2']}' />
                ...
                <input type='hidden' name='filtreChoisi2' value='dynamique' />
            </form>
        </div>
        <%
                    }
        ...
        <DIV id="tableDIV" >
            <%
                    ...
                    String postquery = ") WHERE " + request.getParameter("filtreChoisi") +" AND "+ request.getParameter("filtreChoisi2");
