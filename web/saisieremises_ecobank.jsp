    ...
    <body onload="setFocus()">
        ...
        <div id="tableSaisieRemiseDIV" align="center">
            ...
            <fieldset id="divField">
                ...
                <form  id="remiseForm" name="remiseForm" onsubmit=" return false;">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="numero" value="" size="25" maxlength="12" onKeypress="return numeriqueValide(event);" onblur=" chargeInfoCompteECI();" /></td>
                                <td><input type="text" name="clerib" size="2" value=""  maxlength="2" disabled/></td>
                                    <% } else {%>
                            ...
                            <tr>
                                ...
                                <td> <a:widget name="dojo.combobox" id="agenceCompte"
                                          value="" subscribe="/cl" publish="/choix/agenceECI"/> <!--<input type="text" name="agence" value=""  disabled/>--></td>
                                <td></td>
                                <td></td>
                                <td>Reference: </td>
                    ...
                    Observations:<br>
                    <textarea name="remarques" rows="5" cols="70" >Remarques  ...</textarea>
        ...
        <div id="tableSaisieChequeDIV" align="center">
            <fieldset id="divField">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td></td>
                                <td>Remise: </td>
                                <td><input type="button" name="idremise" value="${requestScope['idremise']}" onclick="location.replace('saisieremises_ecobank.jsp?action=remise&idremise=${requestScope["idremise"]}')"/></td>
                ...
                <br>
                <%if (index > 1) {%>
                <input type="button" value="Precedent" name="Précédent" onclick="window.location.replace('saisieremises_ecobank.jsp?action=precedent&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
                <%}%>
                <%if (nbOpers > index) {%>
                <input type="button" value="Suivant" name="Suivant" onclick="window.location.replace('saisieremises_ecobank.jsp?action=suivant&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
                <%}%>
            </fieldset>
        </div>
        <%}%>
