        ...
        <form  id="creationCompteClient" name="creationCompteClient" onsubmit="return ( doAjaxSubmit(this,undefined,'ControlServlet'));">
            <table border="0" cellspacing="2" cellpadding="2">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Numéro de Compte Externe F12:</td>
                    ...
                    <tr>
                        <td>Agence FlexCube:</td>
                        <td><input type=text name="agenceF12" maxlength="3" /></td>
            ...
            <input type=hidden name="action" value="creationCompteClientF12"/>
