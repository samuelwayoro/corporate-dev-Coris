...
<html>
        ...
        if (params_auto == null || (params_auto != null && params_auto.equalsIgnoreCase("1"))) {
            ...
            if (action != null && (action.equalsIgnoreCase("precedent") || action.equalsIgnoreCase("suivant"))) {
                ...
                if (remises != null && remises.length > 0) {
                    ...
                    out.println("Plus rien à corriger");
                    lastDocType = "";
                }
            }
    ...
    if (message != null && message.getMessage() != null) {
     ...
     ;%>
                ...
                <input type="hidden" value="corrigeRemiseUBAGuinee" name="action" />
        ...
        <div id="tableSaisieChequeDIV" align="center">
            ...
            ;%>
                            ...
                            <td></td>
                            <td>Remise: </td>
                            <td><input type="button" name="idremise" value="${requestScope['idremise']}" onclick="location.replace('correctionremises_ubaguinee.jsp?action=remise&idremise=${requestScope["idremise"]}')"/></td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="codeBanque" value="${requestScope['codeBanque']}" maxlength="3" size="3" onblur=" chargeLibelleBanque();" tabindex="2"/></td>
                            <td></td>
                            <td>Agence:</td>
                            <td><input type="text" name="codeAgence" value="${requestScope['codeAgence']}" maxlength="3" size="3"  onKeypress="return numeriqueValide(event);" tabindex="3"/></td>
                            <td>
                            </td>
                        </tr>
                        <tr>
                            <td>Numero de Compte: </td>
                            <td><input type="text" name="numeroCompte"  value="${requestScope['numeroCompte']}" maxlength="10" onKeypress="return numeriqueValide(event);" tabindex="4"/></td>
                            <td><input type="text" name="clerib" size="2" value="${requestScope['clerib']}"  maxlength="2" tabindex="5"/></td>
                            <td></td>

                            <td>Numero de Cheque:</td>
                            <td><input type="text" name="numeroCheque"  value="${requestScope['numeroCheque']}" maxlength="8" size="8"  onKeypress="return numeriqueValide(event);" tabindex="6"/></td>
                            <td></td>
                ...
                <input type="hidden" value="corrigeChequeUBAGuinee" name="action" />
                <input type="hidden" value="${requestScope['index']}" name="index" />
            </form>
            <b>Cheque ${requestScope['index']} sur ${requestScope['nbOpers']}</b>
            <br>
            <%if (index > 1) {%>
            <input type="button" value="Precedent" name="Précédent" onclick="window.location.replace('correctionremises_ubaguinee.jsp?action=precedent&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
            <%}%>
            <%if (nbOpers > index) {%>
            <input type="button" value="Suivant" name="Suivant" onclick="window.location.replace('correctionremises_ubaguinee.jsp?action=suivant&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
            <%}%>
        </div>
        <%}%>
