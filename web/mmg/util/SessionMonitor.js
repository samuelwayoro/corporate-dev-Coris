 ...
 * logged out.
 */
Ext.define('MMG.util.SessionMonitor', {
    singleton: true,
    interval: 1000 * 10, // run every 10 seconds.
    lastActive: null,
    maxInactive: 1000 * 60 * 30, // 15 minutes of inactivity allowed; set it to 1 for testing. --1000 * 60 * 15
    remaining: 0,
    ui: Ext.getBody(),
    /**
    ...
    window: Ext.create('Ext.window.Window', {
        ...
        buttons: [{
                ...
                handler: function() {
                    Ext.TaskManager.stop(MMG.util.SessionMonitor.countDownTask);
                    MMG.util.SessionMonitor.window.hide();
                    MMG.util.SessionMonitor.start();
                ...
                handler: function() {
                    ...
                    // find and invoke your app's "Logout" button. //viewport #appExit
    ...
    constructor: function(config) {
        console.log('constructor SessionMonitor');
        var me = this;
     ...
     */
    countDown: function() {
                console.log('countDown SessionMonitor');
