...
<html>
        ...
        if (params_auto == null || (params_auto != null && params_auto.equalsIgnoreCase("1"))) {
            ...
            if (action != null && (action.equalsIgnoreCase("precedent") || action.equalsIgnoreCase("suivant"))) {
                ...
                if (remises != null && remises.length > 0) {
                    ...
                    request.setAttribute("nbRemises", remises.length);
    ...
    if (message != null && message.getMessage() != null) {
     ...
     ;%>
                ...
                <p align="center"><input type="text" name="messageStatut" value="${requestScope['nbRemises']}" size="77"  style="text-align:center;color:red;font-size:14pt" disabled/></p>
        ...
        <div id="tableSaisieChequeDIV" align="center">
            ...
            ;%>
                            ...
                            <td></td>
                            <td>Remise: </td>
                            <td><input type="button" name="idremise" value="${requestScope['idremise']}" onclick="location.replace('correctionremises_cbao.jsp?action=remise&idremise=${requestScope["idremise"]}')"/></td>
                            <td></td>
                        </tr>
            ...
            <br>
            <%if (index > 1) {%>
            <input type="button" value="Precedent" name="Précédent" onclick="window.location.replace('correctionremises_cbao.jsp?action=precedent&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
            <%}%>
            <%if (nbOpers > index) {%>
            <input type="button" value="Suivant" name="Suivant" onclick="window.location.replace('correctionremises_cbao.jsp?action=suivant&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
            <%}%>
        </div>
        <%}%>
