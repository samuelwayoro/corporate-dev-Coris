...
<html>
    ...
    <div align="center">
        <form  id="creationCompteClient" name="creationCompteClient" onsubmit="return ( addHiddenCompteLite() && doAjaxSubmit(this,undefined,'ControlServlet'));">
            <table border="0" cellspacing="2" cellpadding="2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type=text name="numCptEx" maxlength="16" onKeypress="return numeriqueValide(event);"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                     ...
                     <td>Etablissement: </td>
                     <td><a:widget name="dojo.combobox" id="idetablissement"
                                              value="${comboEtablissementBean.comboDatas2}" />
                    </tr>
