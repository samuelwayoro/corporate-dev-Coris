...
<html>
    ...
    <body>
        ...
        <h2> Creation d'un Virement BNP</h2>
        <div align="center">
            <jsp:useBean id="comboCompteBean" scope="session" class="clearing.web.bean.ComboCompteBean" />
            <form  id="creationVirementClientBNP" name="creationVirementClientBNP" onsubmit="return (addHiddenVirementBNP() && doAjaxSubmit(this, undefined, 'ControlServlet'));">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a:widget name="dojo.combobox" id="typevirement"
                                      value="${comboTypeVirementBean.comboDatas}" publish="/choix/virementBNP"/></td>
                        </tr>
                        <tr>

                            <td>Numéro de Compte Tiré: </td>
                            <td><input   type="text" id="numeroTire" name="numero" value="" maxlength="16" onKeypress="return numeriqueValide(event);" 
                                         onblur="return recupereInfoCompteBNP(document.forms['creationVirementClientBNP']);" /></td>
                            <td></td>
                            <td>Numéro de Compte Beneficiaire:</td>
                            <td><input    type=text  id ="numeroBen" name="numeroCompteBen" maxlength="12" onKeypress="return numeriqueValide(event);"
                                          onblur="return getVirSiblingsFormBNP(document.forms['creationVirementClientBNP'])"
                                          /></td>
                        </tr>
                        <tr>
                            <td>Nom du Tiré: </td>
                ...
                <input type=hidden name="action" value="creationVirementClientBNP" />
                <input type=hidden name="requete" value="${param['requete']}"/>
                <input type=hidden name="cle" value="${param['cle']}"/>
                <input type=hidden name="cle2" value="${param['cle2']}"/>
                <a:widget name="yahoo.tooltip" args="{context:['creationVirementClientBNP']}" value="Formulaire de Cr&eacute;ation"  />
