        ...
        <form  id="creationVirementClient" name="creationVirementClient" onsubmit="return ( addHiddenVirement() && doAjaxSubmit(this,undefined,'ControlServlet'));">
            <table border="0" cellspacing="2" cellpadding="2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Numéro de Compte Tiré: </td>
                            <td><input type="text" id="numeroTire" name="numero" value="" maxlength="12" onKeypress="return numeriqueValide(event);"
                                       onblur="return recupereInfoCompte(document.forms['creationVirementClient']);" /></td>
                        <td></td>
                    ...
                    <tr>
                            <td>Nom du Tiré: </td>
                            <td><input type="text" id ="nomTire" name="nom" value=""  disabled /></td>
                            <td></td>
                    ...
                    <tr>
                        ...
                        <td><input type=text value="GNF" name="devise" size="3" disabled/></td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
                       ...
                       <tr>
                        ...
                        <td><input type=text id="numeroVir" name="numeroVirement" maxlength="10" onKeypress="return numeriqueValide(event);"/></td>
                        <td></td>
                        <td>Libelle Virement:</td>
                        <td><input type=text id="libelleVir" name="libelleVirement" maxlength="50"/></td>
            ...
            <input type=hidden name="action" value="creationVirementClientACP"/>
