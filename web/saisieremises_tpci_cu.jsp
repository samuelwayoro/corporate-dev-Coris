<%@page contentType="text/html" import="org.patware.jdbc.DataBase,java.math.BigDecimal,clearing.table.Utilisateurs,clearing.web.bean.ComboCompteTPCICUBean"%>
...
<html>
    ...
    <body onload="setFocus()">
        <%
            ...
            ComboCompteTPCICUBean comboCompteTPCICUBean = new ComboCompteTPCICUBean(user);
            session.setAttribute("comboCompteTPCICUBean", comboCompteTPCICUBean);
        ...
        <jsp:useBean id="comboTypeReferenceBean" class="clearing.web.bean.ComboTypeReferenceBean" />
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a:widget name="dojo.combobox" id="compteRemettant"  value="${comboCompteTPCICUBean.comboDatas}"  publish="/cl/getCompteRemettant"/></td>
        ...
        <div id="tableSaisieChequeDIV" align="center">
            <fieldset id="divField">
                ...
                <form  id="chequeForm" name="chequeForm" onsubmit="return false;">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td></td>
                                <td>Remise: </td>
                                <td><input type="button" name="idremise" value="${requestScope['idremise']}" onclick="location.replace('saisieremises_tpci_cu.jsp?action=remise&idremise=${requestScope["idremise"]}')"/></td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>Reference</td>
                                <td><a:widget name="dojo.combobox" id="reference" value="${comboTypeReferenceBean.comboDatas}" /></td>
                                <td>Date Emission:</td>
                            ...
                            <tr>
                                <td>Banque: </td>
                                <td><input type="text" name="codeBanque" value="${requestScope['codeBanque']}" maxlength="5"/></td>
                                <td></td>
                                <td></td>
                                <td>Agence:</td>
                    ...
                    <input type="hidden" value="default" name="reference" />
                ...
                <br>
                <%if (index > 1) {%>
                <input type="button" value="Precedent" name="Précédent" onclick="window.location.replace('saisieremises_tpci_cu.jsp?action=precedent&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
                <%}%>
                <%if (nbOpers > index) {%>
                <input type="button" value="Suivant" name="Suivant" onclick="window.location.replace('saisieremises_tpci_cu.jsp?action=suivant&idcheque=${requestScope['idObjet']}&idremise=${requestScope['idremise']}')"/>
                <%}%>
            </fieldset>
        </div>
        <%}%>
