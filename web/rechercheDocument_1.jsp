...
<html>
    ...
    <body>
        ...
        <form  id="paramUpdate" name="paramUpdate"  onsubmit=" return (areFieldsNotEmpty(this) && showSearchDocsResult('${param['vue']}','${requestScope['filtre']}','${param['objet']}','${param['nomidobjet']}','${requestScope['dropdown']}'));">
