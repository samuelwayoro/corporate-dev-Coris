...
<html>
    ...
    <div align="center">
        ...
        <form  autocomplete="off"  id="creationVirementClient" name="creationVirementClient" onsubmit="return ( addHiddenVirement() && doAjaxSubmit(this,undefined,'ControlServlet'));">
