...
<form  id="param" name="param">
   ...
   value="[
       ...
       {label : 'OU', value : 'OR'}
        ...
        <form  id="paramUpdate" name="paramUpdate"  onsubmit=" return (areFieldsNotEmpty(this) && showQueryResult());">
        <textarea name="query" rows="10" cols="100"></textarea>
        <br/>
        <input type="submit" value="Aperçu" name="apercu" />
