...
<%@page  import="clearing.web.bean.ComboEtatBean,clearing.table.Utilisateurs" contentType="text/html"%>
...
<html>
    ...
    <body onload="return chargeTous()">
        ...
        %>
        <div align="center">
            <form  id="paramsearch" name="paramsearch"  onsubmit="return resolveSearchLite();">
                ...
                <input type=hidden name="etablissement" value="${sessionScope.utilisateur.adresse}" />
