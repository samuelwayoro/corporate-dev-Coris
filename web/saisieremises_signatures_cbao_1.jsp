                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td></td>
                                <td>Remise: </td>
                                <td><input type="button" name="idremise" value="${requestScope['idremise']}" onclick="location.replace('saisieremises_cbao.jsp?action=remise&idremise=${requestScope["idremise"]}')"/></td>
