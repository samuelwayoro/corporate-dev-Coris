...
if(message ==null){
            ...
            " AND "+ args.editor.getColumn().identifiant +" ='"+args.oldData+"'";
                                  ...
                                  //alert(args.oldData);
   if( args.editor.getColumn().table =='REMISES' && args.editor.getColumn().identifiant=='COMPTEREMETTANT' ){
      jmaki.doAjax({
            method: "POST",
            url: "ControlServlet?action=choixNumeroCompte&message=" + encodeURIComponent(args.newData),
            callback: function(_req) {

                var tmp = _req.responseText;

                if(tmp=="rien"){
                    alert("Le numéro de compte "+args.newData+" n'existe pas dans la base Clearing");
                    return;
             ...
             message = "UPDATE "+ args.editor.getColumn().table +
            " SET "+ args.editor.getColumn().identifiant +" ='"+ obj[0].numero +"',NOMCLIENT='"+obj[0].nom+"',AGENCEREMETTANT='"+obj[0].agence+
            "',Escompte="+obj[0].etat+
            " WHERE "+ clause +
            " AND "+ args.editor.getColumn().identifiant +" ='"+args.oldData+"'";
